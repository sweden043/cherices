 ...
 *                  for IRD central IC codenamed Colorado.
 *
 *
 * Author:          Dave Wilson
 *
 ****************************************************************************/
/* $Header: colorado.h, 202, 4/22/04 5:04:24 PM, Sunil Cheruvu$
 ****************************************************************************/
...
/****************************/
#define INTERNAL_ENCODER               NOT_PRESENT
#define INTERNAL_DEMOD                 NOT_PRESENT
#define GPIO_CONFIG                    GPIOM_COLORADO
#define NUM_PARSERS                    1
#define NUM_OSD_PLANES                 1
#define HAS_INTERNAL_PCI32             NO
#define HAS_EXTERNAL_PCI32             NO
#define HAS_PCI32                      (HAS_INTERNAL_PCI32 || HAS_EXTERNAL_PCI32)
#define HSDP_TYPE                      HSDP_COLORADO
#define UART_TYPE                      UART_COLORADO
#ifndef TRACE_PORT
  #define TRACE_PORT                   SERIAL1
#endif
#define ATA_TYPE                       ATA_COLORADO
#define DRM_FILTER_PHASE_0_PROBLEM     YES
#define CPU_TYPE                       CPU_ARM940T
#define MMU_TYPE                       MMU_TYPE_940T
#define PLL_TYPE                       PLL_TYPE_COLORADO
#define MPG_SYNC_BIT_POSITION          MPG_SYNC_BIT_POSITION_COLORADO
#define HSX_ARBITER                    HSX_ARBITER_NONE

#define INTEXP_TYPE                    NOT_PRESENT
#define IIC_TYPE                       IIC_TYPE_COLORADO
#define VIDEO_UCODE_DOWNLOAD_TYPE      VIDEO_UCODE_DOWNLOAD_COLORADO
#define DRM_SCALER_COEFF_TYPE          DRM_SCALER_COEFF_TYPE_COLORADO
#define DRM_CURSOR_FETCH_TYPE          DRM_CURSOR_FETCH_TYPE_COLORADO
...
#define PCM_AUDIO_TYPE                 PCM_AUDIO_COLORADO
...
#undef  HAS_WB_CACHE_BUG
#define HAS_WB_CACHE_BUG           1
...
/*************************************/
  ...
  #define ISCOLORADOREVC (((ISCOLORADO)&&(ChipRevID==PCI_REV_ID_C_COLO))?1:0)
#elif CHIP_REV==REV_C_COLO
  #define ISCOLORADOREVC (1)
#else
  #define ISCOLORADOREVC (0)
#endif

/****************************************************************************/
/* For Colorado chips, the Pawser and GXA need a bit set to allow proper    */
/* arbitration between them. This was introduced on the D1 chip rev.        */
/****************************************************************************/
#define PAWSER_GXA_ARBITRATOR   1
...
/**********************************/
/* Module register base addresses */
/**********************************/

/********************************************/
/* Phase 3 emulation and final hardware map */
/********************************************/
...
#define DPS_BASE(instance) (HW_DWORD)DPS0_BASE
...
#define     DRM_CURSOR_ADDRESS_ADDRESS_MASK                        0x00FFFFFF
#define     DRM_CURSOR_ADDRESS_ADDRESS_SHIFT                              0
#define     DRM_CURSOR_ADDRESS_FETCH_SIZE_MASK                     0x7F000000
#define     DRM_CURSOR_ADDRESS_FETCH_SIZE_SHIFT                          24
#define     DRM_CURSOR_ADDRESS_RESERVED1_MASK                      0x80000000
#define     DRM_CURSOR_ADDRESS_RESERVED1_SHIFT                           31
...
#define     AUD_CHANNEL_CONTROL_RESERVED1_MASK                     0xFFFFFFF8
#define     AUD_CHANNEL_CONTROL_RESERVED1_SHIFT                           3
 ...
 *      PLL_PIN_SC1_PWR_REG                                    (PLL_BASE + 0x60)
 *
 *******************************************************************************
 */
...
#define PLL_CONFIG1_REG                                        (PLL_BASE + 0x24)
#define     PLL_CONFIG1_SC0_PIN_MUX_SELECT_MASK                    0x00000003
#define     PLL_CONFIG1_SC0_PIN_MUX_SELECT_SHIFT                          0
#define         PLL_CONFIG1_SC0PIN_MUX_SELECT_SC0                    (1UL<<0)
#define         PLL_CONFIG1_SC0PIN_MUX_SELECT_NDSCA                  (2UL<<0)
#define     PLL_CONFIG1_SC1_PIN_MUX_SELECT_MASK                    0x00000004
#define     PLL_CONFIG1_SC1_PIN_MUX_SELECT_SHIFT                          2
#define         PLL_CONFIG1_SC1PIN_MUX_SELECT_SCSOCKET               (1UL<<2)
...
#define     PLL_PIN_ALT_FUNC_USBARM_CLK_OBV_MASK                   0x00000002
#define     PLL_PIN_ALT_FUNC_USBARM_CLK_OBV_SHIFT                         1
#define         PLL_PIN_ALT_FUNC_USMARM_CLK_OBV_DISABLE              (0UL<<1)
#define         PLL_PIN_ALT_FUNC_USMARM_CLK_OBV_ENABLE               (1UL<<1)
...
#define         PLL_PIN_ALT_FUNC_UART2_PIO_11_13_PINS                (1UL<<4)
#define         PLL_PIN_ALT_FUNC_UART2_PIO_SMDET_SMDATA_PINS         (2UL<<4)
#define     PLL_PIN_ALT_FUNC_UDMA_ACK_SEL_MASK                     0x000000C0
#define     PLL_PIN_ALT_FUNC_UDMA_ACK_SEL_SHIFT                           6
#define         PLL_PIN_ALT_FUNC_DMAACK_NOT_OUTPUT                   (0UL<<6)
#define         PLL_PIN_ALT_FUNC_DMAACK_OUTPUT_PIO_76                (1UL<<6)
#define         PLL_PIN_ALT_FUNC_DMAACK_OUTPUT_IO_A20                (2UL<<6)
#define     PLL_PIN_ALT_FUNC_AUD_OSC1_SEL_MASK                     0x00000100
#define     PLL_PIN_ALT_FUNC_AUD_OSC1_SEL_SHIFT                           8
#define         PLL_PIN_ALT_FUNC_AUD_OSC1_OUTPUT_DISABLE             (0UL<<8)
#define         PLL_PIN_ALT_FUNC_AUD_OSC1_OUTPUT_ENABLE              (1UL<<8)
#define     PLL_PIN_ALT_FUNC_CA_UART_SEL_MASK                      0x00000200
#define     PLL_PIN_ALT_FUNC_CA_UART_SEL_SHIFT                            9
#define         PLL_PIN_ALT_FUNC_CA_UART_SEL_UART0                   (0UL<<9)
#define         PLL_PIN_ALT_FUNC_CA_UART_SEL_UART1                   (1UL<<9)
...
#define     PLL_PIN_ALT_FUNC_USB2_PIO_SEL_MASK                     0x00000800
#define     PLL_PIN_ALT_FUNC_USB2_PIO_SEL_SHIFT                          11
#define         PLL_PIN_ALT_FUNC_USB2_PIO_SEL_DISABLE               (0UL<<11)
#define         PLL_PIN_ALT_FUNC_USB2_PIO_SEL_ENABLE                (1UL<<11)
...
#define         PLL_PIN_GPIO_MUX0_PWR_BUTTON                         (1UL<<0)
...
#define         PLL_PIN_GPIO_MUX0_TTXREQ                            (1UL<<16)
#define         PLL_PIN_GPIO_MUX0_PIO_17                            (1UL<<17)
#define         PLL_PIN_GPIO_MUX0_MSCTL_DSPKR                       (1UL<<17)
...
#define         PLL_PIN_GPIO_MUX0_MTX_DECLK                         (1UL<<20)
...
#define         PLL_PIN_GPIO_MUX0_DVBCIRST                          (1UL<<25)
#define         PLL_PIN_GPIO_MUX0_PIO_26                            (1UL<<26)
#define         PLL_PIN_GPIO_MUX0_TTXDAT                            (1UL<<26)
...
#define         PLL_PIN_GPIO_MUX1_NIM_FAIL                          (1UL<<26)
...
#define         PLL_PIN_GPIO_MUX2_DMAACK                            (1UL<<12)
...
#define PLL_PIN_SC1_PWR_REG                                    (PLL_BASE + 0x60)
#define     PLL_PIN_SC1_PWR_VCC_CURR_OVERLOAD_PROT_ENABLE_MASK     0x00000001
#define     PLL_PIN_SC1_PWR_VCC_CURR_OVERLOAD_PROT_ENABLE_SHIFT           0
#define         PLL_PIN_SC1_PWR_VCCCUR_OLOAD_PROT_ENABLE             (1UL<<0)
#define     PLL_PIN_SC1_PWR_VR_ENABLE_MASK                         0x00000002
#define     PLL_PIN_SC1_PWR_VR_ENABLE_SHIFT                               1
#define         PLL_PIN_SC1_PWR_VR_DISABLE                           (1UL<<1)
#define     PLL_PIN_SC1_PWR_VCC_CURR_OVERLOAD_STATUS_MASK          0x00010000
#define     PLL_PIN_SC1_PWR_VCC_CURR_OVERLOAD_STATUS_SHIFT               16
#define         PLL_PIN_SC1_PWR_VCCCUR_STATUS_OLOAD                 (1UL<<16)
#define     PLL_PIN_SC1_PWR_VOLT_REG_CURR_OVERLOAD_STATUS_MASK     0x00020000
#define     PLL_PIN_SC1_PWR_VOLT_REG_CURR_OVERLOAD_STATUS_SHIFT          17
#define         PLL_PIN_SC1_PWR_VRCUR_STATUS_OLOAD                  (1UL<<17)
#define         PLL_PIN_SC1_PWR_CLEAR_OLOAD_STATUS_MASK            0x00030000
...
typedef struct _PLL_CONFIG1
{
  BIT_FLD  Reserved:28,
           SC1PinMuxSelect:1,
           SC0PinMuxSelect:2;
} PLL_CONFIG1;
typedef PLL_CONFIG1 volatile *LPPLL_CONFIG1;
...
typedef struct _PLL_PIN_SC1_PWR
{
  BIT_FLD Reserved:15,
          VRCurStatusOload:1,
          VccCurStatusOload:1,
          Reserved1:13,
          VRDisable:1,
          VccCurOloadProtEnable:1;
} PLL_PIN_SC1_PWR;
typedef PLL_PIN_SC1_PWR volatile *LPPLL_PIN_SC1_PWR;
...
#define ITC_RESERVED4_POS       23
#define ITC_GXA_POS             24
#define ITC_UART2_POS           25
#define ITC_NDSC_POS            26
#define ITC_CMTX_POS            27
#define ITC_CMRX_POS            28
...
#define     CNXT_IIC_READDATA_GET(pData, NumBytes)                             \
                  {                                                            \
...
#define GPIO_MUX0_UT2_SEC_ENBL       0x00002800
...
#define     SMC_TIME_CYCLES_MASK                                 0x0000FFFF
 ...
 *      PCI_ATA_DEBUG_REG                                     (PCI_BASE + 0x130)
 *      PCI_ATA_DEBUG2_REG                                    (PCI_BASE + 0x134)
 *
 *******************************************************************************
 */
...
#define PCI_ATA_DEBUG_REG                                     (PCI_BASE + 0x130)
...
#define     PCI_ATA_IF_STATE_MASK                                  0x000F0000
#define     PCI_ATA_IF_STATE_SHIFT                                       16
#define     PCI_ATA_MWDMA_STATE_MASK                               0x00F00000
#define     PCI_ATA_MWDMA_STATE_SHIFT                                    20

#define PCI_ATA_DEBUG2_REG                                    (PCI_BASE + 0x134)
#define     PCI_ATA_DMA_COUNT_MASK                                 0x0FFFFFF0
#define     PCI_ATA_DMA_COUNT_SHIFT                                       4
#define     PCI_ATA_FIFO_ENTRIES_MASK                              0xF0000000
#define     PCI_ATA_FIFO_ENTRIES_SHIFT                                   28
...
/* last updated 1/25/00 to match 1/17 Colorado Spec */
#ifdef INCL_MPG
/*
 *******************************************************************************
 * Registers common to Sabine and Neches
 ...
 *
 * The other Neches MPG registers have moved to the DPS block
 *******************************************************************************
 */
...
#define     MPG_CONTROL1_AUDIOMODE_MASK                            0x00000003
#define     MPG_CONTROL1_AUDIOMODE_SHIFT                                  0
#define     MPG_CONTROL1_KARAOKEMODE0_MASK                         0x00000004
#define     MPG_CONTROL1_KARAOKEMODE0_SHIFT                               2
#define     MPG_CONTROL1_OUTPUTLEFTJUSTIFIED_MASK                  0x00000008
#define     MPG_CONTROL1_OUTPUTLEFTJUSTIFIED_SHIFT                        3
...
#define     MPG_CONTROL1_KARAOKEMODE1_MASK                         0x00008000
#define     MPG_CONTROL1_KARAOKEMODE1_SHIFT                              15
...
#define     MPG_ERROR_STATUS_USEROVERFLOW_MASK                     0x00000010
#define     MPG_ERROR_STATUS_USEROVERFLOW_SHIFT                           4
#define     MPG_ERROR_STATUS_ANCOVERFLOW_MASK                      0x00000020
#define     MPG_ERROR_STATUS_ANCOVERFLOW_SHIFT                            5
...
/*******************************************************************************
 * chip bug on colorado regarding test_start_dsp bit within DSR.
 * Is bit[14] within register and can be read as bit[14] but must
 * be written using bit[12]. Thus the seperate TESTSTARTDSPWRITE and 
 * TESTSTARTDSPREAD mask and shift entries.
 *******************************************************************************/
#define     MPG_DECODE_STATUS_TESTSTARTDSPWRITE_MASK               0x00001000
#define     MPG_DECODE_STATUS_TESTSTARTDSPWRITE_SHIFT                    12
#define     MPG_DECODE_STATUS_TESTDSPDONE_MASK                     0x00002000
#define     MPG_DECODE_STATUS_TESTDSPDONE_SHIFT                          13
#define     MPG_DECODE_STATUS_TESTSTARTDSPREAD_MASK                0x00004000
#define     MPG_DECODE_STATUS_TESTSTARTDSPREAD_SHIFT                     14
#define     MPG_DECODE_STATUS_RESETINPROGRESS_MASK                 0x00008000
#define     MPG_DECODE_STATUS_RESETINPROGRESS_SHIFT                      15
...
/* MPG_CONTROL1 */
#define MPG_AUDIOMODE_AC3  0x00
#define MPG_AUDIOMODE_L1   0x01
#define MPG_AUDIOMODE_L2   0x02
#define MPG_AUDIOMODE_LPCM 0x03
...
#define MPG_COMMAND_SKIPB        0x0010
#define MPG_COMMAND_SKIPP        0x0018
...
/* With macroblock-based microcode, MPG_COMMAND_PAUSE takes a parameter */
/* indicating which type of scaling to use.                             */
#define MPG_COMMAND_FIELD_SCALE  0x1000
#define MPG_COMMAND_FRAME_SCALE  0x1001
...
/* Bit position definitions when using register as a HW_DWORD */
  ...
  #define MPG_USER_OVERFLOW       0x0000010
  #define MPG_ANC_OVERFLOW        0x0000020
...
/* MPG_VID_SIZE */
/* Bits 0 and 1 (bottom 2 bits of the width field) of the video  */
/* size register tell us which  buffer contains the last decoded */
/* image.                                                        */
#define MPG_VID_MASK_COMPLETE       3
#define MPG_VID_I_COMPLETE          0
#define MPG_VID_P_COMPLETE          1
#define MPG_VID_B_COMPLETE          2

/* Bit 2 of the register indicates top field decoded */
#define MPG_VID_FIELD_MASK          4
#define MPG_VID_TOP_FIELD_FLAG      4
#define MPG_VID_BOTTOM_FIELD_FLAG   0

/* Bits 16 and 17 (bottom 2 bits of the height field) tell us which */
/* was the last buffer sent to the DRM for display                  */
#define MPG_VID_MASK_DISPLAYED      0x30000
#define MPG_VID_I_DISPLAYED         0x00000
#define MPG_VID_P_DISPLAYED         0x10000
#define MPG_VID_B_FRAME_DISPLAYED   0x20000
#define MPG_VID_B_FIELD_DISPLAYED   0x30000

/* Bit 18 (third but of the height field) indicates whether or not */
/* video playback is in sync (assuming AV sync is enabled)         */
#define MPG_VID_MASK_IN_SYNC        0x40000
#define MPG_VID_IN_SYNC             0x40000
#define MPG_VID_NOT_IN_SYNC         0x00000
...
{
  BIT_FLD Width:10,     /* NB: Mask off bottom 3 bits when reading - see below for definitions */
          Reserved1:6,
          Height:10,    /* NB: Mask off bottom 3 bits when reading - see below for definitions */
          Reserved2:2,
          AspectRatio:4;
} MPG_VID_SIZE;
 ...
 *      HSDP_TNF_CLK_CNTL_REG                                  (HSDP_BASE + 0x44)
...
#define     HSDP_BIDIR_PORT_CNTL_OUTPUT_CLK_POLARITY_MASK          0x00000010
#define     HSDP_BIDIR_PORT_CNTL_OUTPUT_CLK_POLARITY_SHIFT                4
#define         HSDP_BIDIR_PORT_CNTL_OUTPUT_CLK_POLARITY_RISING_EDGE (0UL<<4)
#define         HSDP_BIDIR_PORT_CNTL_OUTPUT_CLK_POLARITY_FALLING_EDGE (1UL<<4)
...
#define     HSDP_BIDIR_PORT_CNTL_OUTPUT_DATA_SUBSEL_MASK           0x00040000
#define     HSDP_BIDIR_PORT_CNTL_OUTPUT_DATA_SUBSEL_SHIFT                18
#define         HSDP_BIDIR_PORT_CNTL_OUTPUT_DATA_SUBSEL_PARSER0     (0UL<<18)
#define         HSDP_BIDIR_PORT_CNTL_OUTPUT_DATA_SUBSEL_PARSER1     (1UL<<18)
/* "no-op" */
#define     HSDP_BIDIR_PORT_CNTL_SER_TO_PAR_CONV_MASK              0x0 
#define     HSDP_BIDIR_PORT_CNTL_SER_TO_PAR_CONV_DISABLE            (0<<0)
#define     HSDP_BIDIR_PORT_CNTL_SER_TO_PAR_CONV_ENABLE             (0<<0)


#define HSDP_SP_INPUT_CNTL_REG                                 (HSDP_BASE + 0x20)
#define     HSDP_SP_INPUT_CNTL_PARSER0_INPUT_SEL_MASK              0x00000003
#define     HSDP_SP_INPUT_CNTL_PARSER0_INPUT_SEL_SHIFT                    0
#define         HSDP_SP_INPUT_CNTL_PARSER0_SER_NIM_PORT_0            (0UL<<0)
#define         HSDP_SP_INPUT_CNTL_PARSER0_BIDIR_PORT_0              (1UL<<0)
#define         HSDP_SP_INPUT_CNTL_PARSER0_BIDIR_PORT_1              (2UL<<0)
...
#define HSDP_TNF_CLK_CNTL_REG                                  (HSDP_BASE + 0x44)
 ...
 *******************************************************************************
 *
 *  There are three mapping sections each with a header.  For Colorado, there
 *  is one demux/pawser in the chip.
 *
 ...
 *      DPS_DVR_VIDEO_WRITE_PTR_EX                       (DPS_BASE + 0x00000290)
 *      DPS_DVR_VIDEO_READ_PTR_EX                        (DPS_BASE + 0x00000294)
 *      DPS_DVR_VIDEO_START_ADDR_EX                      (DPS_BASE + 0x00000298)
 *      DPS_DVR_VIDEO_END_ADDR_EX                        (DPS_BASE + 0x0000029C)
 *      DPS_DVR_AUDIO_WRITE_PTR_EX                       (DPS_BASE + 0x000002A0)
 *      DPS_DVR_AUDIO_READ_PTR_EX                        (DPS_BASE + 0x000002A4)
 *      DPS_DVR_AUDIO_START_ADDR_EX                      (DPS_BASE + 0x000002A8)
 *      DPS_DVR_AUDIO_END_ADDR_EX                        (DPS_BASE + 0x000002AC)
 *      DPS_DVR_AUDIO1_WRITE_PTR_EX                      (DPS_BASE + 0x000002B0)
 *      DPS_DVR_AUDIO1_READ_PTR_EX                       (DPS_BASE + 0x000002B4)
 *      DPS_DVR_AUDIO1_START_ADDR_EX                     (DPS_BASE + 0x000002B8)
 *      DPS_DVR_AUDIO1_END_ADDR_EX                       (DPS_BASE + 0x000002BC)
 *      DPS_DVR_AUDIO2_WRITE_PTR_EX                      (DPS_BASE + 0x000002C0)
 *      DPS_DVR_AUDIO2_READ_PTR_EX                       (DPS_BASE + 0x000002C4)
 *      DPS_DVR_AUDIO2_START_ADDR_EX                     (DPS_BASE + 0x000002C8)
 *      DPS_DVR_AUDIO2_END_ADDR_EX                       (DPS_BASE + 0x000002CC)
 *      DPS_DVR_EVENT_WRITE_PTR_EX                       (DPS_BASE + 0x00000480)
 *      DPS_DVR_EVENT_READ_PTR_EX                        (DPS_BASE + 0x00000484)
 *      DPS_DVR_EVENT_START_ADDR_EX                      (DPS_BASE + 0x00000488)
 *      DPS_DVR_EVENT_END_ADDR_EX                        (DPS_BASE + 0x0000048C)
...
#define DPS_DVR_EVENT_END_ADDR_EX(instance)                                    \
                              ((volatile HW_DWORD *)(DPS_BASE(instance)+0x048C))
...
#define     DPS_ALT_TRANSPORT_BLOCK_STORED_MASK                    0x00000008
#define     DPS_ALT_TRANSPORT_BLOCK_STORED_SHIFT                          3
#define         DPS_ALT_TRANSPORT_BLOCK_STORED                       (1UL<<3)
...
#define     DPS_ALT_TRANSPORT_BUFFER_FULL_MASK                     0x00000020
#define     DPS_ALT_TRANSPORT_BUFFER_FULL_SHIFT                           5
#define         DPS_ALT_TRANSPORT_BUFFER_FULL                        (1UL<<5)
...
#define DMA_CONTROL_REG_CH(x)  (((x)*DMA_CHANNEL_SIZE)+DMA_CONTROL_OFFSET) /* per channel configuration */
   ...
   #define DMA_XACT_SZ(x)               ((x-1)<<8) /* Move this many 32-bit words                        */
...
#define HWBUF_TOP                (HWBUF_CAM_EMM_START_ADDR + HWBUF_CAM_EMM_SIZE)

/* Hardware bug specific to colorado, IR data is inverted in certain cases */
#define COLORADO_IR_INVERT_BUG     

/* hardware bug specific to Colorado, causes a CHROMA problem in certain cases */
#define COLORADO_CHROMA_WIPE_BUG
 ...
 * Modifications:
 * $Log: 
 *  202  mpeg      1.201       4/22/04 5:04:24 PM     Sunil Cheruvu   CR(s) 
 *        8870 8871 : Added the Nand Flash support for Wabash(Milano rev 5 and 
 *        above) and Brazos(Bronco).
 *  201  mpeg      1.200       3/10/04 2:54:10 PM     Larry Wang      CR(s) 
 *        8551 : Add definition of registers for Sony Passage.
 *  200  mpeg      1.199       3/10/04 10:41:38 AM    Bob Van Gulick  CR(s) 
 *        8546 : Add support to return PES frame rate
 *  199  mpeg      1.198       2/24/04 2:42:38 PM     Bob Van Gulick  CR(s) 
 *        8427 : Add timebase_offset functionality to demux
 *        
 *  198  mpeg      1.197       2/11/04 8:34:17 AM     Steven Jones    CR(s) 
 ...
 *  197  mpeg      1.196       2/4/04 3:00:24 PM      Dave Wilson     CR(s) 
 *        8319 8318 : Added new chip bug identifier 
 *        DRM_NEEDS_SPLIT_FIFO_ON_WIPE (set to NO for this chip).
 *        
 *  196  mpeg      1.195       11/1/03 2:45:07 PM     Tim Ross        CR(s): 
 *        7719 7762 Added definitions for RST_SCRATCH_REG bits.
 *  195  mpeg      1.194       10/30/03 4:20:25 PM    Tim Ross        CR(s): 
 *        7719 7762 Added definitions for scratch register 0.
 *  194  mpeg      1.193       10/2/03 2:42:06 PM     Craig Dry       SCR(s) 
 *        7532 :
 *        New defines for Power Driver
 *        
 *  193  mpeg      1.192       9/19/03 6:48:10 PM     Dave Aerne      SCR(s) 
 *        7514 :
 *        cleanup to map CORE_RESET defines to standard CONTROL0 defines
 *        
 *  192  mpeg      1.191       8/18/03 2:32:08 PM     Miles Bintz     SCR(s) 
 *        7291 :
 *        added mmy type definitions
 *        
 *  191  mpeg      1.190       7/16/03 1:03:02 PM     Dave Aerne      SCR(s) 
 *        6987 :
 *        fixed definition of MPG_DECODE_STATUS_TESTDSP bit for colorado.
 *        Chip bug on colorado requires this bit to be read as bit[14] but 
 *        written as bit[12].
 *        
 *  190  mpeg      1.189       6/9/03 5:57:10 PM      Bob Van Gulick  SCR(s) 
 *        6755 :
 ...
 *        
 *        
 *  189  mpeg      1.188       6/6/03 11:09:38 AM     Dave Wilson     SCR(s) 
 *        6738 6737 :
 *        Added CHIP_SUPPORTS_XXX_RESET definitions.
 *        
 *  188  mpeg      1.187       5/22/03 5:30:42 PM     Dave Wilson     SCR(s) 
 *        6564 6565 :
 *        Added definitions of CACHE_LINE_SIZE and NONCACHEABLE_RAM_MASK. 
 *        Previously
 *        these were in various KAL files.
 *        
 *  187  mpeg      1.186       5/20/03 6:11:34 PM     Dave Wilson     SCR(s) 
 *        6499 6500 :
 *        Added ENCODER_HAS_DAC_BUG for Brazos rev B.
 *        
 *  186  mpeg      1.185       5/15/03 3:34:42 PM     Dave Wilson     SCR(s) 
 *        6367 6366 :
 *        Added new macro DRM_HAS_16_BIT_CURSOR_BUG.
 *        
 *  185  mpeg      1.184       5/5/03 4:03:34 PM      Tim White       SCR(s) 
 *        6172 :
 *        Add ROM_BASE definition.
 *        
 *        
 *  184  mpeg      1.183       5/2/03 11:13:48 AM     Bob Van Gulick  SCR(s) 
 *        6151 :
 *        Add pts_offset and dma_mux memory locations
 *        
 *        
 *  183  mpeg      1.182       4/23/03 11:08:02 AM    Dave Wilson     SCR(s) 
 *        5862 :
 *        Added DRM_TILE_TYPE chip feature due to changes in Brazos.
 *        
 *  182  mpeg      1.181       4/21/03 4:43:28 PM     Dave Wilson     SCR(s) 
 *        6057 :
 *        Added definitions for the new parameters required by 
 *        MPG_COMMAND_PAUSE,
 *        MPG_COMMAND_FRAME_SCALE and MPG_COMMAND_FIELD_SCALE.
 *        
 *  181  mpeg      1.180       3/28/03 4:22:20 PM     Dave Wilson     SCR(s) 
 *        5883 :
 *        Redefined INTERNAL_ENCODER as NOT_PRESENT rather than EXTERNAL. 
 *        Although these
 *        are defined to the same value, it may have caused some confusion 
 *        since code
 *        that checks the macro tends to use NOT_PRESENT.
 *        
 *  180  mpeg      1.179       3/13/03 12:22:02 PM    Miles Bintz     SCR(s) 
 *        5753 :
 *        Added HSDP_BIDIR_PORT_CNTL_SER_TO_PAR_CONV_DISABLE definition to chip
 *         header file
 *        
 *        
 *  179  mpeg      1.178       3/5/03 3:51:10 PM      Miles Bintz     SCR(s) 
 *        5634 :
 *        added CHIP_SUPPORTS_PIO_TIMED_RESET feature definition to chip header
 *         files
 *        
 *        
 *  178  mpeg      1.177       2/21/03 5:38:36 PM     Dave Aerne      SCR(s) 
 *        4672 :
 *        for audio format is AUTO_DETECTION, added DPS_AUDIO_PID_STREAM_ID_EX 
 *        at DPS_BASE address offset 0x1fc.
 *        
 *  177  mpeg      1.176       2/19/03 10:50:54 AM    Dave Wilson     SCR(s) 
 *        5528 5543 :
 ...
 *        
 *  176  mpeg      1.175       2/4/03 5:07:36 PM      Bob Van Gulick  SCR(s) 
 *        5407 :
 *        Change scrambling status to use separate TS and PES registers
 *        
 *        
 *  175  mpeg      1.174       1/24/03 7:00:48 PM     Brendan Donahe  SCR(s) 
 *        5315 :
 *        Updated 16-bit MC audio workaround fix with PCM_AUDIO_TYPE 
 *        definition.
 *        
 *        
 *  174  mpeg      1.173       1/15/03 3:51:18 PM     Billy Jackman   SCR(s) 
 *        5095 :
 *        Added specification of INTERNAL_DEMOD as NOT_PRESENT.
 *        
 *  173  mpeg      1.172       1/10/03 3:18:20 PM     Miles Bintz     SCR(s) 
 *        5227 :
 *        Undefine HAS_WB_CACHE_BUG before defining it to be one.  This allows 
 *        defuault definition of 0 to be defined in swconfig for other chips
 *        
 *        
 *  172  mpeg      1.171       12/17/02 3:55:42 PM    Tim White       SCR(s) 
 *        5182 :
 *        Remove ARM_PIT_TYPE, no longer needed.  Added HAS_WB_CACHE_BUG to 
 *        ensure WB cache
 *        is never enabled on a Colorado since it's pre-Rev_2 ARM940.  Added 
 *        default ASB_MODE value.
 *        
 *        
 *  171  mpeg      1.170       12/12/02 5:14:42 PM    Tim White       SCR(s) 
 *        5157 :
 *        Changed ISCOLORADOREVC macro to use the ISCOLORADO chip ID so all PCI
 *         ID's are checked
 *        correctly.   Removed PCI_ROM_MODE_REG_TYPE def'n.
 *        
 *        
 *  170  mpeg      1.169       12/10/02 3:03:24 PM    Dave Wilson     SCR(s) 
 *        5071 :
 *        Added VIDEO_UCODE_RAM_SIZE_WORDS chip feature to define the size of 
 *        the video
 *        microcode RAM.
 *        
 *  169  mpeg      1.168       12/10/02 1:58:56 PM    Bob Van Gulick  SCR(s) 
 *        5121 :
 *        Add scrambler status memory location for demux
 *        
 *        
 *  168  mpeg      1.167       12/10/02 1:34:34 PM    Dave Wilson     SCR(s) 
 *        5091 :
 *        Reworked interrupt controller bit positions
 *        
 *  167  mpeg      1.166       12/6/02 5:12:16 PM     Dave Wilson     SCR(s) 
 *        4903 :
 *        Added new chip features to differentiate some DRM function changes in
 *         Brazos
 *        
 *  166  mpeg      1.165       10/30/02 2:46:10 PM    Bobby Bradford  SCR(s) 
 *        4866 :
 ...
 *        
 *  165  mpeg      1.164       10/28/02 1:56:02 PM    Dave Wilson     SCR(s) 
 *        4851 :
 *        Removed all double-slash comments since OpenTV's ocode compiler 
 *        doesn't
 *        support them and we could not build our menu, banner and setup apps 
 *        as a result
 *        
 *  164  mpeg      1.163       10/21/02 4:47:02 PM    Senthil Veluswamy SCR(s) 
 *        4790 :
 *        added define for the Audio AC3 Align Error
 *        
 *  163  mpeg      1.162       10/11/02 12:20:40 PM   Miles Bintz     SCR(s) 
 *        4431 :
 *        Added config option for hsx arbiter type
 *        
 *        
 *  162  mpeg      1.161       9/17/02 5:43:14 PM     Carroll Vance   SCR(s) 
 *        4613 :
 *        Added HAS_INTERNAL_PCI32 and HAS_EXTERNAL_PCI32
 *        
 *  161  mpeg      1.160       9/16/02 11:19:40 AM    Joe Kroesche    SCR(s) 
 *        4610 :
 *        oops, comment in bad place
 *        
 *  160  mpeg      1.159       9/16/02 11:12:34 AM    Joe Kroesche    SCR(s) 
 *        4610 :
 *        added DPS_ macro needed for crc notification feature
 *        
 *  159  mpeg      1.158       8/30/02 6:34:02 PM     Senthil Veluswamy SCR(s) 
 *        4502 :
 *        Defines for using the New IIC interface
 *        
 *  158  mpeg      1.157       8/30/02 3:02:44 PM     Larry Wang      SCR(s) 
 *        4499 :
 *        Define INTEXP_TYPE as NOT_PRESENT.
 *        
 *  157  mpeg      1.156       8/30/02 2:40:16 PM     Bob Van Gulick  SCR(s) 
 *        4485 :
 *        Add defines to support CRC checking in demux driver
 *        
 *        
 *  156  mpeg      1.155       8/22/02 6:02:16 PM     Brendan Donahe  SCR(s) 
 *        4464 :
 ...
 *        
 *        
 *  155  mpeg      1.154       8/22/02 4:03:16 PM     Larry Wang      SCR(s) 
 *        4459 :
 *        Define PCI_ROM_MODE_REG_TYPE.
 *        
 *  154  mpeg      1.153       8/19/02 9:42:16 AM     Tim White       SCR(s) 
 *        4421 :
 *        Added changes required for the new DVR pawser microcode changes.
 *        
 *        
 *  153  mpeg      1.152       8/15/02 6:52:06 PM     Tim Ross        SCR(s) 
 *        4409 :
 *        Moved all chip-specific default definitions from hconfig.
 *        
 *  152  mpeg      1.151       8/14/02 4:54:50 PM     Dave Wilson     SCR(s) 
 *        4371 :
 *        Corrected definition of DRM_COLOR_KEY_REG contents. Should be 24 bits
 *         +
 *        8 reserved bits rather than 16 + 16 reserved.
 *        
 *  151  mpeg      1.150       6/21/02 11:28:28 AM    Dave Wilson     SCR(s) 
 *        4061 :
 *        Added definition of new feature DRM_FILTER_PHASE_0_PROBLEM. This 
 *        relates
 *        to a problem in the DRM scaler which causes faint vertical lines to 
 *        be seen
 *        when using particular scaling factors.
 *        
 *  150  mpeg      1.149       6/14/02 11:08:34 AM    Carroll Vance   SCR(s) 
 *        3786 :
 ...
 *        
 *  149  mpeg      1.148       6/13/02 10:52:04 AM    Carroll Vance   SCR(s) 
 *        3786 :
 *        turning off DRM bitfields
 *        
 *  148  mpeg      1.147       6/6/02 5:54:28 PM      Craig Dry       SCR(s) 
 *        3923 :
 *        Remove MPG bitfields conditionally - Step 1
 *        
 *  147  mpeg      1.146       6/3/02 3:18:12 PM      Carroll Vance   SCR(s) 
 *        3923 :
 *        Added definitions for MPG bit fields.
 *        
 *        
 *  146  mpeg      1.145       6/3/02 2:49:06 PM      Craig Dry       SCR(s) 
 *        3922 :
 *        Conditionally remove SYN bitfield structures from header files
 *        
 *  145  mpeg      1.144       6/3/02 12:52:08 PM     Carroll Vance   SCR(s) 
 *        3918 :
 *        Forgot to change one use of PLL_LOCK_CMD to PLL_LOCK_CMD_VALUE. Fixed
 *         it.
 *        
 *  144  mpeg      1.143       6/3/02 12:43:32 PM     Carroll Vance   SCR(s) 
 *        3918 :
 ...
 *        
 *  143  mpeg      1.142       5/31/02 7:28:52 PM     Craig Dry       SCR(s) 
 *        3916 :
 *        Eradicate bitfield use from AFE code
 *        
 *  142  mpeg      1.141       5/31/02 12:09:14 PM    Craig Dry       SCR(s) 
 *        3908 :
 *        Eradicate bitfield use from Smart Card(SMC) code, step 1
 *        
 *  141  mpeg      1.140       5/30/02 12:32:50 PM    Tim White       SCR(s) 
 *        3899 :
 *        Add WARM_RESET support.
 *        
 *        
 *  140  mpeg      1.139       5/28/02 6:01:52 PM     Tim White       SCR(s) 
 *        3876 :
 *        Fixed PCI_ATA_XFER_COUNT_xxxx definitions.
 *        
 *        
 *  139  mpeg      1.138       5/22/02 5:42:14 PM     Craig Dry       SCR(s) 
 *        3855 :
 *        Eradicate bitfield use from SER(Serial) code, step 1
 *        
 *  138  mpeg      1.137       5/21/02 2:05:48 PM     Tim White       SCR(s) 
 *        3642 :
 *        Add DPS_PCR_BLOCK_STORED bit definition for new pawser microcode 
 *        build option -dPCR_PID_INT.
 *        
 *        
 *  137  mpeg      1.136       5/21/02 1:32:32 PM     Carroll Vance   SCR(s) 
 *        3786 :
 *        Added LPREG in front of DRM register addresses.
 *        
 *  136  mpeg      1.135       5/17/02 12:17:32 PM    Craig Dry       SCR(s) 
 *        3810 :
 *        Eradicate bitfield use from IRD code
 *        
 *  135  mpeg      1.134       5/15/02 3:09:00 PM     Craig Dry       SCR(s) 
 *        3794 :
 *        Eradicate bitfields from PAR module
 *        
 *  134  mpeg      1.133       5/15/02 2:56:08 PM     Carroll Vance   SCR(s) 
 *        3786 :
 *        Added constants for DRM bitfields.
 *        
 *  133  mpeg      1.132       5/15/02 12:19:24 PM    Carroll Vance   SCR(s) 
 *        3789 1238924 :
 *        Clean up audio bitfield masks.
 *        
 *  132  mpeg      1.131       5/14/02 5:23:58 PM     Craig Dry       SCR(s) 
 *        3784 :
 *        Eradicate bitfields from PWM(Pulse Width Modulator)
 *        
 *  131  mpeg      1.130       5/14/02 11:45:26 AM    Craig Dry       SCR(s) 
 *        3776 :
 *        Eradicate bitfield use from PLS(Pulse Timer), step 1
 *        
 *  130  mpeg      1.129       5/13/02 1:55:38 PM     Tim White       SCR(s) 
 *        3760 :
 *        Updated DPS_ definition section.
 *        
 *        
 *  129  mpeg      1.128       5/10/02 3:19:42 PM     Craig Dry       SCR(s) 
 *        3754 :
 *        Eradicate bitfield use from SDR(SDRAM) code
 *        
 *  128  mpeg      1.127       5/7/02 5:58:04 PM      Craig Dry       SCR(s) 
 *        3726 :
 *        Eradicate bitfield use from I2C, step 1
 *        
 *  127  mpeg      1.126       5/6/02 5:59:30 PM      Tim White       SCR(s) 
 *        3714 :
 *        Update HSDP_ macro definitions to use new bitfield-less format.
 *        
 *        
 *  126  mpeg      1.125       5/3/02 3:49:14 PM      Craig Dry       SCR(s) 
 *        3671 :
 *        Eradicate bitfield use from TIM module
 *        
 *  125  mpeg      1.124       5/3/02 2:46:52 PM      Tim White       SCR(s) 
 *        3696 :
 *        Remove RST_ bitfields from codebase.
 *        
 *        
 *  124  mpeg      1.123       5/3/02 1:56:36 PM      Dave Wilson     SCR(s) 
 *        3688 :
 *        Added definitions of new parser events used to detect data on audio 
 *        and 
 *        video PIDs.
 *        
 *  123  mpeg      1.122       5/2/02 5:26:34 PM      Dave Wilson     SCR(s) 
 *        3694 :
 *        Definitions of contents of the MPG_ERROR_REG did not agree between 
 *        bitfields
 *        and #defines. They are now correct.
 *        
 *  122  mpeg      1.121       5/2/02 5:25:38 PM      Tim White       SCR(s) 
 *        3693 :
 *        Use "UL" in the macro bit definitions to force unsigned and fix 
 *        compiler warnings.
 *        
 *        
 *  121  mpeg      1.120       5/1/02 7:00:10 PM      Carroll Vance   SCR(s) 
 *        3659 :
 *        Removed audio bitfield types.
 *        
 *  120  mpeg      1.119       5/1/02 5:45:02 PM      Tim White       SCR(s) 
 *        3678 :
 *        Remove GCP_ & ARM_ bitfields usage from the codebase.
 *        
 *        
 *  119  mpeg      1.118       5/1/02 3:30:40 PM      Tim White       SCR(s) 
 *        3673 :
 *        Remove PLL_ bitfields usage from codebase.
 *        
 *        
 *  118  mpeg      1.117       4/30/02 5:37:48 PM     Joe Kroesche    SCR(s) 
 *        3243 :
 *        added definition for new parser event bit (bad PES header)
 *        
 *  117  mpeg      1.116       4/30/02 4:20:06 PM     Craig Dry       SCR(s) 
 *        3662 :
 *        Use same build configurations as were used to test defect 3509. 
 *        
 *  116  mpeg      1.115       4/30/02 2:55:54 PM     Carroll Vance   SCR(s) 
 *        3659 :
 *        Removing bitfields from audio, step 1.
 *        
 *        
 *  115  mpeg      1.114       4/30/02 12:58:40 PM    Billy Jackman   SCR(s) 
 *        3656 :
 *        Changed expression (1<<31) to ((unsigned)1<<31) to avoid compiler 
 *        warning
 *        in SDT toolset.
 *        
 *  114  mpeg      1.113       4/29/02 6:16:58 PM     Craig Dry       SCR(s) 
 *        3652 :
 *        Eliminate bitfield use from Movie (MOV) module by conditional 
 *        compilation.
 *        
 *  113  mpeg      1.112       4/24/02 4:27:20 PM     Dave Wilson     SCR(s) 
 *        3611 :
 ...
 *        different register.
 *        
 *  112  mpeg      1.111       4/22/02 3:22:02 PM     Larry Wang      SCR(s) 
 *        3585 :
 ...
 *        extender.
 *        
 *  111  mpeg      1.110       4/19/02 5:52:36 PM     Craig Dry       SCR(s) 
 *        3588 :
 *        Conditionally compile out RTC bitfield definitions.
 *        
 *  110  mpeg      1.109       4/18/02 11:07:28 AM    Craig Dry       SCR(s) 
 *        3576 :
 *        Turns out that none of the code was actually using bitfields for the 
 *        GXA.  They were defined, but not used.  The definitions are now 
 *        conditionally compiled out.
 *        
 *  109  mpeg      1.108       4/12/02 7:50:26 PM     Tim White       SCR(s) 
 *        3558 :
 *        Remove hardware register access macros.  Now in hwconfig.h.
 *        
 *        
 *  108  mpeg      1.107       4/11/02 3:15:18 PM     Tim White       SCR(s) 
 *        3543 :
 ...
 *        
 *        
 *  107  mpeg      1.106       4/10/02 5:15:42 PM     Tim White       SCR(s) 
 *        3509 :
 *        Eradicate external bus (PCI) bitfield usage.
 *        
 *        
 *  106  mpeg      1.105       4/5/02 2:19:36 PM      Tim White       SCR(s) 
 *        3510 :
 *        Backout DCS #3468
 *        
 *        
 *  105  mpeg      1.104       4/3/02 10:16:22 AM     Dave Wilson     SCR(s) 
 *        3494 :
 ...
 *        
 *  104  mpeg      1.103       3/28/02 2:09:20 PM     Quillian Rutherford 
 *        SCR(s) 3468 :
 *        Masks have been defined for the previously used bitfields.  These
 *        bit field definitions still exist for now.  Also added CNXT_FLAG_GET 
 *        and
 *        CNXT_FLAG_SET macros.
 *        
 *        
 *  103  mpeg      1.102       3/4/02 5:49:20 PM      Tim White       SCR(s) 
 *        3299 :
 *        Add ATA_TYPE definition and misc req'd for ATA driver.
 *        
 *        
 *  102  mpeg      1.101       3/4/02 4:09:48 PM      Tim White       SCR(s) 
 *        3296 :
 *        Added PLL_DIV2_ definitions for defect DCS #3286 which weren't 
 *        dropped.
 *        
 *        
 *  101  mpeg      1.100       2/21/02 4:21:54 PM     Tim White       SCR(s) 
 *        3229 :
 *        Use NUM_PARSERS definition for DPS_NUM_DEMUXES.
 *        
 *        
 *  100  mpeg      1.99        1/11/02 10:45:34 AM    Dave Moore      SCR(s) 
 *        3006 :
 *        added SDRAM 64MB_256, changed 32MB_64 to 32MB_128
 *        
 *        
 *  99   mpeg      1.98        1/11/02 10:34:14 AM    Miles Bintz     SCR(s) 
 *        3027 :
 *        Deleted generic_reg_set/get macro and replaced it with 
 *        cnxt_reg_set/get
 *        
 *        
 *  98   mpeg      1.97        1/8/02 12:07:56 PM     Senthil Veluswamy SCR(s) 
 *        2998 :
 *        Added defines for CONFIG1 & SW_PWR registers & new defines for 
 *        ALT_FUNC bit values
 *        
 *  97   mpeg      1.96        12/19/01 4:26:08 PM    Bob Van Gulick  SCR(s) 
 *        2977 :
 *        Fix another missing prameter on a macro
 *        
 *        
 *  96   mpeg      1.95        12/19/01 10:28:14 AM   Bob Van Gulick  SCR(s) 
 *        2977 :
 *        Fix a couple macro definitions that had the incorrect number of 
 *        parameters
 *        
 *        
 *  95   mpeg      1.94        12/19/01 9:17:52 AM    Tim Ross        SCR(s) 
 *        2933 :
 *        Changed duplicate HSDP_PORT_MODE_1394_READ to 
 *        HSDP_PORT_MODE_1394_WRITE.
 *        
 *  94   mpeg      1.93        12/18/01 2:49:34 PM    Miles Bintz     SCR(s) 
 *        2933 :
 *        Added Traceport define, HSDP register definitions, and other merges 
 *        from wabash branch
 *        
 *        
 *  93   mpeg      1.92        12/18/01 9:50:14 AM    Bob Van Gulick  SCR(s) 
 *        2977 :
 *        Changes to support new multi-instance demux driver
 *        
 *        
 *  92   mpeg      1.91        11/29/01 6:04:54 PM    Quillian Rutherford 
 *        SCR(s) 2933 :
 *        Added a define for a colorado bug with the IR input being inverted.
 *        See the hardware Errata on Colorado for details on this bug.
 *        
 *        
 *  91   mpeg      1.90        11/29/01 2:24:10 PM    Matt Korte      SCR(s) 
 *        2937 :
 ...
 *        
 *        
 *  90   mpeg      1.89        11/29/01 12:59:30 PM   Miles Bintz     SCR(s) 
 *        2936 :
 *        added extra pci config register offsets
 *        
 *  89   mpeg      1.88        11/7/01 3:47:32 PM     Dave Wilson     SCR(s) 
 *        2872 :
 *        Added definition of MPG_COMMAND_FLUSH_VBV
 *        
 *  88   mpeg      1.87        11/7/01 2:17:54 PM     Bobby Bradford  SCR(s) 
 *        2753 :
 *        Added definition of PLL_TYPE for CODELDR changes
 *        
 *  87   mpeg      1.86        10/29/01 2:06:54 PM    Bobby Bradford  SCR(s) 
 *        2828 :
 *        Changed basetype.h typedef references (e.g. u_int32) to hwconfig.h 
 *        typedef
 *        references (e.g. HW_DWORD) to avoid problems with undefined or 
 *        conflicting
 *        typedefs since hwconfig.h now includes boxcfg.h, which includes 
 *        "chip.h"
 *        
 *  86   mpeg      1.85        10/17/01 10:11:54 AM   Tim White       SCR(s) 
 *        2799 :
 *        Added N3 ICAM function.
 *        
 *        
 *  85   mpeg      1.84        9/6/01 2:50:04 PM      Tim White       SCR(s) 
 *        2592 :
 *        Added Per-Slot-PSI/PES buffer support for the new microcodes
 *        built with -dMULTI_PSI.  In the source tree, these microcodes
 *        are denoted with a "p" (e.g. dvb_anp.c is the Colorado version
 *        of BSkyB NDS Per-Slot-PSI micrcode).
 *        
 *        
 *  84   mpeg      1.83        7/16/01 1:09:24 PM     Quillian Rutherford 
 *        SCR(s) 2298 2299 2300 2301 2302 :
 *        Added a MPEG_CORE_RESET_HIGH definition for the video reset sequence 
 *        to use.
 *        
 *        
 *  83   mpeg      1.82        7/12/01 12:53:06 PM    Tim White       SCR(s) 
 *        2261 2259 2260 :
 *        Allow forward compatibility with multi-instance DMX HW support
 *        in Hondo.  The changes made with this defect are begign to any
 *        code which includes this header file for building with the
 *        colorado chip.
 *        
 *        
 *  82   mpeg      1.81        7/10/01 6:33:02 PM     Dave Wilson     SCR(s) 
 *        2238 2237 :
 *        Changed definitions of video decode buffers (MPG_VID_P_COMPLETE, etc)
 *         to match latest video microcode drop.
 *        
 *  81   mpeg      1.80        7/3/01 10:43:20 AM     Tim White       SCR(s) 
 *        2178 2179 2180 :
 *        Merge branched Hondo specific code back into the mainstream source 
 *        database.
 *        
 *        
 *  80   mpeg      1.79        5/11/01 11:42:50 AM    Tim White       
 *        DCS#1894/1895/1896 -- Changed MPG_COMMAND_PAUSE from 0x28 to 0x1028.
 *        
 *  79   mpeg      1.78        4/20/01 12:13:44 PM    Dave Wilson     DCS1124: 
 *        Major changes to video memory management to get Sky Text app running
 *        
 *  78   mpeg      1.77        4/18/01 5:32:18 PM     Amy Pratt       DCS1642 
 *        Added chip feature definitions in preparation for new Hondo code.
 *        
 *  77   mpeg      1.76        1/30/01 11:00:18 AM    Tim White       DCS#1011:
 *         Set DAA_DIV register.
 *        
 *  76   mpeg      1.75        12/7/00 11:53:00 AM    Ismail Mustafa  Added 
 *        definition of MPG_AUD_SYNC_ENABLED
 *        
 *  75   mpeg      1.74        10/12/00 2:28:50 PM    Tim Ross        Corrected
 *         PLL_PIN_MUXSEL structure for rev A & B to match hardware.
 *        
 *  74   mpeg      1.73        10/6/00 6:28:22 PM     Tim Ross        Added pin
 *         muxing definitions for redirecting UART2 through the 
 *        smartcard pins.
 *        
 *  73   mpeg      1.72        10/5/00 6:42:56 PM     Tim White       Added 
 *        encode buffer low-water mark registers.
 *        
 *  72   mpeg      1.71        9/27/00 6:41:18 PM     Senthil Veluswamy New 
 *        Register Macros to Address dual banks of Conexant Smartcard Registers
 *        
 *  71   mpeg      1.70        9/26/00 6:05:06 PM     Tim White       Added 
 *        switchable secondary descriptor capability to low-level flash 
 *        function.
 *        
 *  70   mpeg      1.69        9/15/00 3:46:38 PM     Anzhi Chen      Added 
 *        definitions for absolute values writting to registers for pulse 
 *        timer.
 *        
 *  69   mpeg      1.68        9/8/00 5:39:26 PM      Tim White       Fixed 
 *        typo in ATA_UDMA register definition.
 *        
 *  68   mpeg      1.67        9/7/00 8:14:04 PM      Senthil Veluswamy Added 
 *        Macros to read a GPIO pin's Value
 *        
 *  67   mpeg      1.66        9/7/00 7:37:44 PM      Tim White       Updated 
 *        ATA subsystem definitions.
 *        
 *  66   mpeg      1.65        9/6/00 7:35:54 PM      Senthil Veluswamy Added 
 *        PLL_PIN_SC1_PWR_REG
 *        
 *  65   mpeg      1.64        9/6/00 6:04:42 PM      Tim White       Added RST
 *         ASB memory instruction prefetch enable mechanism.
 *        
 *  64   mpeg      1.63        9/5/00 11:01:10 AM     Tim White       Updated 
 *        pin mux hardware interface for Rev C.
 *        
 *  63   mpeg      1.62        8/15/00 3:37:06 PM     Dave Wilson     Replaced 
 *        critical section calls in GPIO macros with HWLIB versions. The
 *        previous level of the header used OTVKAL equivalents instead
 *        
 *  62   mpeg      1.61        7/26/00 12:37:10 PM    Lucy C Allevato Added DVR
 *         PTS event source type definitions.
 *        
 *  61   mpeg      1.60        7/14/00 5:29:34 PM     Ismail Mustafa  Added DPS
 *         defines for CANAL PLUS filtering.
 *        
 *  60   mpeg      1.59        6/29/00 1:07:40 PM     Dave Wilson     Added 
 *        module flag for RST component
 *        
 *  59   mpeg      1.58        6/21/00 5:31:58 PM     Tim White       Added 
 *        Colorado Rev_C changes (pin muxing changes).
 *        
 *  58   mpeg      1.57        6/1/00 5:53:54 PM      Tim White       Fixed bug
 *         in DVR_EVENT block layout...
 *        
 *  57   mpeg      1.56        5/25/00 6:11:20 PM     Tim White       Added a 
 *        few more DVR details...
 *        
 *  56   mpeg      1.55        5/24/00 6:01:50 PM     Dave Moore      Revised 
 *        DMA to reflect current CX2249X silicon.
 *        
 *  55   mpeg      1.54        5/24/00 4:47:02 PM     Tim White       Fixed 
 *        compiler warning...
 *        
 *  54   mpeg      1.53        5/24/00 4:35:24 PM     Tim White       Added DVR
 *         definitions, datatypes, and buffer size/location #defines.
 *        
 *  53   mpeg      1.52        5/15/00 6:33:32 PM     Senthil Veluswamy Defined
 *         SER_NUM_PORTS and Frame Control Register aliases
 *        
 *  52   mpeg      1.51        5/15/00 5:36:48 PM     Senthil Veluswamy Added 
 *        SER_FIFO_DEPTH
 *        
 *  51   mpeg      1.50        5/12/00 3:52:46 PM     Anzhi Chen      Added 
 *        PLL_RTC_DIV_54MHz_TO_1HZ.
 *        
 *  50   mpeg      1.49        5/11/00 6:17:34 PM     Senthil Veluswamy added 
 *        definition for TX/RX FIFO Status registers
 *        
 *  49   mpeg      1.48        5/10/00 7:30:34 PM     Senthil Veluswamy Added 
 *        definition  and Macros for Uart IRLVL register
 *        
 *  48   mpeg      1.47        5/4/00 12:14:36 PM     Ismail Mustafa  Fixed ESR
 *         bits which were incorrect in the SPEC.
 *        
 *  47   mpeg      1.46        5/2/00 5:54:02 PM      Ismail Mustafa  MPEG 
 *        Error Mask register bit 0 is the real bitstream error bit.
 *        Documentation was wrong.
 *        
 *  46   mpeg      1.45        5/2/00 5:28:32 PM      Dave Wilson     Added fix
 *         to MAKE_GPIO_INPUT for Colorado Rev A bug
 *        
 *  45   mpeg      1.44        5/1/00 5:20:18 PM      Dave Wilson     Corrected
 *         PWN control register definition
 *        
 *  44   mpeg      1.43        4/28/00 3:42:12 PM     Tim White       Fixed 
 *        SDR_RANK_32MB_128 definitions to match HW.
 *        
 *  43   mpeg      1.42        4/28/00 11:23:08 AM    Dave Wilson     Corrected
 *         definitions of PCI_ROM_MODE_REG
 *        
 *  42   mpeg      1.41        4/26/00 11:22:50 AM    Tim White       Make 
 *        Colorado UART changes consistent between .h and .a files.
 *        
 *  41   mpeg      1.40        4/26/00 10:52:46 AM    Dave Wilson     Fixed 
 *        typos in some new serial register macros
 *        
 *  40   mpeg      1.39        4/26/00 1:22:16 AM     Tim White       Colorado 
 *        uses UART3.
 *        
 *  39   mpeg      1.38        4/24/00 10:31:56 PM    Tim White       Removed 
 *        the RSO_ definitions from chip specific header file and
 *        placed into vendor/board specific header file.
 *        
 *  38   mpeg      1.37        4/24/00 11:17:20 AM    Tim White       Moved 
 *        strapping CONFIG0 from chip header file(s) to board header file(s).
 *        
 *  37   mpeg      1.36        4/12/00 3:55:36 PM     Dave Wilson     Changed 
 *        definition of PLL_CONFIG0 to use a union describing the different
 *        possibilities for the register.
 *        
 *  36   mpeg      1.35        4/10/00 6:35:06 PM     Rob Tilton      Added the
 *         bit defines for the last decoded mpg buffer.
 *        
 *  35   mpeg      1.34        4/10/00 6:21:40 PM     Ismail Mustafa  Added 
 *        defines for Control Reg 0 for non bitfield code.
 *        
 *  34   mpeg      1.33        3/31/00 6:11:44 PM     Ismail Mustafa  Removed 
 *        all NDS ICAM related things.
 *        
 *  33   mpeg      1.32        3/31/00 4:05:32 PM     Lucy C Allevato Updated 
 *        GXA definitions to match up with specification.
 *        
 *  32   mpeg      1.31        3/30/00 4:07:58 PM     Dave Wilson     Updated 
 *        PWM registers and changed name of PLL_GPIO_MUX_REG to match spec
 *        
 *  31   mpeg      1.30        3/22/00 4:26:20 PM     Tim White       Removed 
 ...
 *        
 *  30   mpeg      1.29        3/17/00 4:08:50 PM     Tim White       Added ATA
 *         register descriptions to the PCI section.
 *        
 *  29   mpeg      1.28        3/8/00 2:09:52 PM      Lucy C Allevato Fixed 
 *        incorrect values for 32 bpp OSD pixel type definitions.
 *        
 *  28   mpeg      1.27        3/3/00 1:45:26 PM      Tim Ross        Added 
 *        SER_TX/RX_FIFO_STATUS_REG/(x) definitions for the 
 *        serial port FIFO status registers.
 *        
 *  27   mpeg      1.26        3/2/00 5:27:02 PM      Tim White       Added 
 *        Colorado Chip/Rev ID #define's.
 *        
 *  26   mpeg      1.25        2/29/00 7:05:14 PM     Senthil Veluswamy new 
 *        defines to Enable ICAM PinMux
 *        
 *  25   mpeg      1.24        2/18/00 5:20:00 PM     Ismail Mustafa  Added 
 *        more defines to remove bitfields.
 *        
 *  24   mpeg      1.23        2/8/00 6:08:24 PM      Ismail Mustafa  Added DSP
 *         SWAP bit.
 *        
 *  23   mpeg      1.22        2/4/00 2:40:32 PM      Ismail Mustafa  Added 
 *        defines for no bit field changes.
 *        
 *  22   mpeg      1.21        2/1/00 4:08:08 PM      Ismail Mustafa  Changed 
 *        GPI bank size from 0x100 to 0x30.
 *        
 *  21   mpeg      1.20        1/31/00 4:03:34 PM     Ismail Mustafa  More DPS 
 *        changes. PidTidEnable register removed.
 *        
 *  20   mpeg      1.19        1/25/00 5:48:34 PM     Amy Pratt       Updated 
 *        MPG section to match the 1/17 Colorado Spec.  Removed
 *        definitions that do not apply to Colorado.
 *        
 *  19   mpeg      1.18        1/24/00 10:58:30 AM    Tim Ross        Updated 
 *        SDR_RANK0/1_SIZE.
 *        Corrected ARM_DBG_COMM WriteRdy to WriteBsy.
 *        
 *  18   mpeg      1.17        1/21/00 10:31:52 AM    Senthil Veluswamy 
 *        Restored CAM register bit position definitions
 *        
 *  17   mpeg      1.16        1/21/00 10:21:04 AM    Senthil Veluswamy Added 
 *        CAM_CONFIG_OUT Reg, updated address for 
 *        - CAM0_ENABLE Reg.
 *        Replaced CAM bit position definitions with Bit-field definitions.
 *        
 *  16   mpeg      1.15        1/20/00 3:09:00 PM     Rob Tilton      The upper
 *         3 bits of the OSD field 1 address have been moved to the MSB of 
 *        OSD field 2.
 *        
 *  15   mpeg      1.14        1/20/00 2:56:48 PM     Ismail Mustafa  Cleanup 
 *        Old key enable and PAWSER stuff.
 *        
 *  14   mpeg      1.13        1/12/00 2:46:08 PM     Tim Ross        Added 
 *        resistor strapping config register changes for COlorado.
 *        
 *  13   mpeg      1.12        1/11/00 7:24:06 PM     Amy Pratt       Removed 
 *        definitions of MPG registers that have moved to DPS
 *        
 *  12   mpeg      1.11        1/11/00 6:22:52 PM     Tim Ross        Added 
 *        SDRAM changes for Colorado.
 *        
 *  11   mpeg      1.10        1/11/00 3:38:58 PM     Tim Ross        Added 
 *        debug comm port definition to ARM section.
 *        
 *  10   mpeg      1.9         1/10/00 4:58:08 PM     Ismail Mustafa  Fixed 
 *        incorrect define for shift value of ECM enable.
 *        
 *  9    mpeg      1.8         1/6/00 5:08:20 PM      Lucy C Allevato Added 
 *        some new defines for 32 bit access to GXA config registers.
 *        
 *  8    mpeg      1.7         1/6/00 1:29:52 PM      Rob Tilton      Added 
 *        Colorado DRM register definitions.
 *        
 *  7    mpeg      1.6         1/3/00 9:25:44 AM      Ismail Mustafa  More 
 *        PAWSER stuff.
 *        
 *  6    mpeg      1.5         12/8/99 5:11:24 PM     Tim Ross        Added 
 *        changes for Colorado.
 *        
 *  5    mpeg      1.4         12/1/99 3:01:28 PM     Lucy C Allevato Added 
 *        definitions for graphics acceleration.
 *        
 *  4    mpeg      1.3         12/1/99 2:23:02 PM     Ismail Mustafa  More 
 *        Parser stuff.
 *        
 *  3    mpeg      1.2         11/29/99 5:19:08 PM    Ismail Mustafa  Added new
 *         Parser definitions.
 *        
 *  2    mpeg      1.1         10/29/99 10:07:24 AM   Dave Wilson     Added 
 *        RST_LOWPOWER_REG
 *        
 *  1    mpeg      1.0         10/12/99 11:54:16 AM   Dave Wilson     
 * $
 * 
 *    Rev 1.193   02 Oct 2003 13:42:06   dryd
 * SCR(s) 7532 :
 * New defines for Power Driver
 * 
 *    Rev 1.192   19 Sep 2003 17:48:10   aernedj
 * SCR(s) 7514 :
 * cleanup to map CORE_RESET defines to standard CONTROL0 defines
 * 
 *    Rev 1.191   18 Aug 2003 13:32:08   bintzmf
 * SCR(s) 7291 :
 * added mmy type definitions
 * 
 *    Rev 1.190   16 Jul 2003 12:03:02   aernedj
 * SCR(s) 6987 :
 * fixed definition of MPG_DECODE_STATUS_TESTDSP bit for colorado.
 * Chip bug on colorado requires this bit to be read as bit[14] but 
 * written as bit[12].
 * 
 *    Rev 1.189   09 Jun 2003 16:57:10   vangulr
 * SCR(s) 6755 :
 * Add support for 8 slot descram in demux.  Needed to move registers between 1E0 and 200 to a different location to support this feature.
 * 
 * 
 *    Rev 1.188   06 Jun 2003 10:09:38   dawilson
 * SCR(s) 6738 6737 :
 * Added CHIP_SUPPORTS_XXX_RESET definitions.
 * 
 *    Rev 1.187   22 May 2003 16:30:42   dawilson
 * SCR(s) 6564 6565 :
 * Added definitions of CACHE_LINE_SIZE and NONCACHEABLE_RAM_MASK. Previously
 * these were in various KAL files.
 * 
 *    Rev 1.186   20 May 2003 17:11:34   dawilson
 * SCR(s) 6499 6500 :
 * Added ENCODER_HAS_DAC_BUG for Brazos rev B.
 * 
 *    Rev 1.185   15 May 2003 14:34:42   dawilson
 * SCR(s) 6367 6366 :
 * Added new macro DRM_HAS_16_BIT_CURSOR_BUG.
 * 
 *    Rev 1.184   05 May 2003 15:03:34   whiteth
 * SCR(s) 6172 :
 * Add ROM_BASE definition.
 * 
 * 
 *    Rev 1.183   02 May 2003 10:13:48   vangulr
 * SCR(s) 6151 :
 * Add pts_offset and dma_mux memory locations
 * 
 * 
 *    Rev 1.182   23 Apr 2003 10:08:02   dawilson
 * SCR(s) 5862 :
 * Added DRM_TILE_TYPE chip feature due to changes in Brazos.
 * 
 *    Rev 1.181   21 Apr 2003 15:43:28   dawilson
 * SCR(s) 6057 :
 * Added definitions for the new parameters required by MPG_COMMAND_PAUSE,
 * MPG_COMMAND_FRAME_SCALE and MPG_COMMAND_FIELD_SCALE.
 * 
 *    Rev 1.180   28 Mar 2003 16:22:20   dawilson
 * SCR(s) 5883 :
 * Redefined INTERNAL_ENCODER as NOT_PRESENT rather than EXTERNAL. Although these
 * are defined to the same value, it may have caused some confusion since code
 * that checks the macro tends to use NOT_PRESENT.
 * 
 *    Rev 1.179   13 Mar 2003 12:22:02   bintzmf
 * SCR(s) 5753 :
 * Added HSDP_BIDIR_PORT_CNTL_SER_TO_PAR_CONV_DISABLE definition to chip header file
 * 
 * 
 *    Rev 1.178   05 Mar 2003 15:51:10   bintzmf
 * SCR(s) 5634 :
 * added CHIP_SUPPORTS_PIO_TIMED_RESET feature definition to chip header files
 * 
 * 
 *    Rev 1.177   21 Feb 2003 17:38:36   aernedj
 * SCR(s) 4672 :
 * for audio format is AUTO_DETECTION, added DPS_AUDIO_PID_STREAM_ID_EX at DPS_BASE address offset 0x1fc.
 * 
 *    Rev 1.176   19 Feb 2003 10:50:54   dawilson
 * SCR(s) 5528 5543 :
 * Added 2 new chip features to enable workarounds for a couple of DRM bugs:
 * DRM_HAS_WIPE_CHROMA_BUG = YES 
 * DRM_HAS_UPSCALE_PAL_STILL_BUG = YES
 * 
 *    Rev 1.175   04 Feb 2003 17:07:36   vangulr
 * SCR(s) 5407 :
 * Change scrambling status to use separate TS and PES registers
 * 
 * 
 *    Rev 1.174   24 Jan 2003 19:00:48   donaheb
 * SCR(s) 5315 :
 * Updated 16-bit MC audio workaround fix with PCM_AUDIO_TYPE definition.
 * 
 * 
 *    Rev 1.173   15 Jan 2003 15:51:18   jackmaw
 * SCR(s) 5095 :
 * Added specification of INTERNAL_DEMOD as NOT_PRESENT.
 * 
 *    Rev 1.172   10 Jan 2003 15:18:20   bintzmf
 * SCR(s) 5227 :
 * Undefine HAS_WB_CACHE_BUG before defining it to be one.  This allows defuault definition of 0 to be defined in swconfig for other chips
 * 
 * 
 *    Rev 1.171   17 Dec 2002 15:55:42   whiteth
 * SCR(s) 5182 :
 * Remove ARM_PIT_TYPE, no longer needed.  Added HAS_WB_CACHE_BUG to ensure WB cache
 * is never enabled on a Colorado since it's pre-Rev_2 ARM940.  Added default ASB_MODE value.
 * 
 * 
 *    Rev 1.170   12 Dec 2002 17:14:42   whiteth
 * SCR(s) 5157 :
 * Changed ISCOLORADOREVC macro to use the ISCOLORADO chip ID so all PCI ID's are checked
 * correctly.   Removed PCI_ROM_MODE_REG_TYPE def'n.
 * 
 * 
 *    Rev 1.169   10 Dec 2002 15:03:24   dawilson
 * SCR(s) 5071 :
 * Added VIDEO_UCODE_RAM_SIZE_WORDS chip feature to define the size of the video
 * microcode RAM.
 * 
 *    Rev 1.168   10 Dec 2002 13:58:56   vangulr
 * SCR(s) 5121 :
 * Add scrambler status memory location for demux
 * 
 * 
 *    Rev 1.167   10 Dec 2002 13:34:34   dawilson
 * SCR(s) 5091 :
 * Reworked interrupt controller bit positions
 * 
 *    Rev 1.166   06 Dec 2002 17:12:16   dawilson
 * SCR(s) 4903 :
 * Added new chip features to differentiate some DRM function changes in Brazos
 * 
 *    Rev 1.165   30 Oct 2002 14:46:10   bradforw
 * SCR(s) 4866 :
 * Fixed the PLL_PIN_ALT_FUNCT_AFE_DAA_DEL values ...
 * the values in the header files matched the specs, but the
 * spec is backwards.
 ...
 * bit 17 to bit 24 (for Kobuk ... Wabash is actually a don't care)
 * 
 *    Rev 1.164   28 Oct 2002 13:56:02   dawilson
 * SCR(s) 4851 :
 * Removed all double-slash comments since OpenTV's ocode compiler doesn't
 * support them and we could not build our menu, banner and setup apps as a result
 * 
 *    Rev 1.163   21 Oct 2002 15:47:02   velusws
 * SCR(s) 4790 :
 * added define for the Audio AC3 Align Error
 * 
 *    Rev 1.162   11 Oct 2002 11:20:40   bintzmf
 * SCR(s) 4431 :
 * Added config option for hsx arbiter type
 * 
 * 
 *    Rev 1.161   17 Sep 2002 16:43:14   vancec
 * SCR(s) 4613 :
 * Added HAS_INTERNAL_PCI32 and HAS_EXTERNAL_PCI32
 * 
 *    Rev 1.160   16 Sep 2002 10:19:40   kroescjl
 * SCR(s) 4610 :
 * oops, comment in bad place
 * 
 *    Rev 1.159   16 Sep 2002 10:12:34   kroescjl
 * SCR(s) 4610 :
 * added DPS_ macro needed for crc notification feature
 * 
 *    Rev 1.158   30 Aug 2002 17:34:02   velusws
 * SCR(s) 4502 :
 * Defines for using the New IIC interface
 * 
 *    Rev 1.157   30 Aug 2002 14:02:44   wangl2
 * SCR(s) 4499 :
 * Define INTEXP_TYPE as NOT_PRESENT.
 * 
 *    Rev 1.156   30 Aug 2002 13:40:16   vangulr
 * SCR(s) 4485 :
 * Add defines to support CRC checking in demux driver
 * 
 * 
 *    Rev 1.155   22 Aug 2002 17:02:16   donaheb
 * SCR(s) 4464 :
 * Repaired DRMYCCPAL_CB_* and DRMYCCPAL_CR_* to correctly match YCbCr ordering
 * applicable to default 8 bit palette
 * 
 * 
 *    Rev 1.154   22 Aug 2002 15:03:16   wangl2
 * SCR(s) 4459 :
 * Define PCI_ROM_MODE_REG_TYPE.
 * 
 *    Rev 1.153   19 Aug 2002 08:42:16   whiteth
 * SCR(s) 4421 :
 * Added changes required for the new DVR pawser microcode changes.
 * 
 * 
 *    Rev 1.152   15 Aug 2002 17:52:06   rossst
 * SCR(s) 4409 :
 * Moved all chip-specific default definitions from hconfig.
 * 
 *    Rev 1.151.1.0   16 Aug 2002 17:03:08   whiteth
 * SCR(s) 4420 :
 * Added changes for new DVR pawser microcode which supports DVR,
 * XPRT, and MULTI_PSI together.
 *
 *    Rev 1.151   14 Aug 2002 15:54:50   dawilson
 * SCR(s) 4371 :
 * Corrected definition of DRM_COLOR_KEY_REG contents. Should be 24 bits +
 * 8 reserved bits rather than 16 + 16 reserved.
 * 
 *    Rev 1.150   21 Jun 2002 10:28:28   dawilson
 * SCR(s) 4061 :
 * Added definition of new feature DRM_FILTER_PHASE_0_PROBLEM. This relates
 * to a problem in the DRM scaler which causes faint vertical lines to be seen
 * when using particular scaling factors.
 * 
 *    Rev 1.149   14 Jun 2002 10:08:34   vancec
 * SCR(s) 3786 :
 * Allowed use of DRM bitfields only in individual c files by putting 
 * #define USE_BITFIELD_DRM
 * at the top of a c file before #include'ing any header files that
 ...
 * are pervasive, especially the RBG and YCC bitfields.
 * 
 *    Rev 1.148   13 Jun 2002 09:52:04   vancec
 * SCR(s) 3786 :
 * turning off DRM bitfields
 * 
 *    Rev 1.147   06 Jun 2002 16:54:28   dryd
 * SCR(s) 3923 :
 * Remove MPG bitfields conditionally - Step 1
 * 
 *    Rev 1.146   03 Jun 2002 14:18:12   vancec
 * SCR(s) 3923 :
 * Added definitions for MPG bit fields.
 * 
 * 
 *    Rev 1.145   03 Jun 2002 13:49:06   dryd
 * SCR(s) 3922 :
 * Conditionally remove SYN bitfield structures from header files
 * 
 *    Rev 1.144   03 Jun 2002 11:52:08   vancec
 * SCR(s) 3918 :
 * Forgot to change one use of PLL_LOCK_CMD to PLL_LOCK_CMD_VALUE. Fixed it.
 * 
 *    Rev 1.143   03 Jun 2002 11:43:32   vancec
 * SCR(s) 3918 :
 * Changed PLL_LOCK_CMD to PLL_LOCK_CMD_VALUE to avoid conflict with bitfield type PLL_LOCK_CMD when customer uses this file with code containing use of PLL_LOCK_CMD bitfield type.
 * 
 *    Rev 1.142   31 May 2002 18:28:52   dryd
 * SCR(s) 3916 :
 * Eradicate bitfield use from AFE code
 * 
 *    Rev 1.141   31 May 2002 11:09:14   dryd
 * SCR(s) 3908 :
 * Eradicate bitfield use from Smart Card(SMC) code, step 1
 * 
 *    Rev 1.140   30 May 2002 11:32:50   whiteth
 * SCR(s) 3899 :
 * Add WARM_RESET support.
 * 
 * 
 *    Rev 1.139   28 May 2002 17:01:52   whiteth
 * SCR(s) 3876 :
 * Fixed PCI_ATA_XFER_COUNT_xxxx definitions.
 * 
 * 
 *    Rev 1.138   22 May 2002 16:42:14   dryd
 * SCR(s) 3855 :
 * Eradicate bitfield use from SER(Serial) code, step 1
 * 
 *    Rev 1.137   21 May 2002 13:05:48   whiteth
 * SCR(s) 3642 :
 * Add DPS_PCR_BLOCK_STORED bit definition for new pawser microcode build option -dPCR_PID_INT.
 * 
 * 
 *    Rev 1.136   21 May 2002 12:32:32   vancec
 * SCR(s) 3786 :
 * Added LPREG in front of DRM register addresses.
 * 
 *    Rev 1.135   17 May 2002 11:17:32   dryd
 * SCR(s) 3810 :
 * Eradicate bitfield use from IRD code
 * 
 *    Rev 1.134   15 May 2002 14:09:00   dryd
 * SCR(s) 3794 :
 * Eradicate bitfields from PAR module
 * 
 *    Rev 1.133   15 May 2002 13:56:08   vancec
 * SCR(s) 3786 :
 * Added constants for DRM bitfields.
 * 
 *    Rev 1.132   15 May 2002 11:19:24   vancec
 * SCR(s) 3789 1238924 :
 * Clean up audio bitfield masks.
 * 
 *    Rev 1.131   14 May 2002 16:23:58   dryd
 * SCR(s) 3784 :
 * Eradicate bitfields from PWM(Pulse Width Modulator)
 * 
 *    Rev 1.130   14 May 2002 10:45:26   dryd
 * SCR(s) 3776 :
 * Eradicate bitfield use from PLS(Pulse Timer), step 1
 * 
 *    Rev 1.129   13 May 2002 12:55:38   whiteth
 * SCR(s) 3760 :
 * Updated DPS_ definition section.
 * 
 * 
 *    Rev 1.128   10 May 2002 14:19:42   dryd
 * SCR(s) 3754 :
 * Eradicate bitfield use from SDR(SDRAM) code
 *
 *    Rev 1.127   07 May 2002 16:58:04   dryd
 * SCR(s) 3726 :
 * Eradicate bitfield use from I2C, step 1
 * 
 *    Rev 1.126   06 May 2002 16:59:30   whiteth
 * SCR(s) 3714 :
 * Update HSDP_ macro definitions to use new bitfield-less format.
 * 
 * 
 *    Rev 1.125   03 May 2002 14:49:14   dryd
 * SCR(s) 3671 :
 * Eradicate bitfield use from TIM module
 * 
 *    Rev 1.124   03 May 2002 13:46:52   whiteth
 * SCR(s) 3696 :
 * Remove RST_ bitfields from codebase.
 * 
 * 
 *    Rev 1.123   03 May 2002 12:56:36   dawilson
 * SCR(s) 3688 :
 * Added definitions of new parser events used to detect data on audio and
 * video PIDs.
 *
 *    Rev 1.122   02 May 2002 16:26:34   dawilson
 * SCR(s) 3694 :
 * Definitions of contents of the MPG_ERROR_REG did not agree between bitfields
 * and #defines. They are now correct.
 * 
 *    Rev 1.121   02 May 2002 16:25:38   whiteth
 * SCR(s) 3693 :
 * Use "UL" in the macro bit definitions to force unsigned and fix compiler warnings.
 * 
 * 
 *    Rev 1.120   01 May 2002 18:00:10   vancec
 * SCR(s) 3659 :
 * Removed audio bitfield types.
 * 
 *    Rev 1.119   01 May 2002 16:45:02   whiteth
 * SCR(s) 3678 :
 * Remove GCP_ & ARM_ bitfields usage from the codebase.
 * 
 * 
 *    Rev 1.118   01 May 2002 14:30:40   whiteth
 * SCR(s) 3673 :
 * Remove PLL_ bitfields usage from codebase.
 * 
 * 
 *    Rev 1.117   30 Apr 2002 16:37:48   kroescjl
 * SCR(s) 3243 :
 * added definition for new parser event bit (bad PES header)
 * 
 *    Rev 1.116   30 Apr 2002 15:20:06   dryd
 * SCR(s) 3662 :
 * Use same build configurations as were used to test defect 3509. 
 * 
 *    Rev 1.115   30 Apr 2002 13:55:54   vancec
 * SCR(s) 3659 :
 * Removing bitfields from audio, step 1.
 * 
 * 
 *    Rev 1.114   30 Apr 2002 11:58:40   jackmaw
 * SCR(s) 3656 :
 * Changed expression (1<<31) to ((unsigned)1<<31) to avoid compiler warning
 * in SDT toolset.
 * 
 *    Rev 1.113   29 Apr 2002 17:16:58   dryd
 * SCR(s) 3652 :
 * Eliminate bitfield use from Movie (MOV) module by conditional compilation.
 * 
 *    Rev 1.112   24 Apr 2002 15:27:20   dawilson
 * SCR(s) 3611 :
 * Updated video size register bit definitions to match latest microcode. For
 * Colorado and Hondo this affects only MPG_VID_SIZE_REG but for Wabash the
 * changes were made to MPG_ADDR_EXT_REG since the affected bits have moved to a
 * different register.
 * 
 *    Rev 1.111   22 Apr 2002 14:22:02   wangl2
 * SCR(s) 3585 :
 * Add definition of NUM_OF_GPIO for COLORADO, HONDO and WABASH chips.  Any GPIO bit number that is bigger than NUM_OF_GPIO means GPIO extender.
 * 
 *    Rev 1.110   19 Apr 2002 16:52:36   dryd
 * SCR(s) 3588 :
 * Conditionally compile out RTC bitfield definitions.
 * 
 *    Rev 1.109   18 Apr 2002 10:07:28   dryd
 * SCR(s) 3576 :
 * Turns out that none of the code was actually using bitfields for the GXA.  They were defined, but not used.  The definitions are now conditionally compiled out.
 * 
 *    Rev 1.108   12 Apr 2002 18:50:26   whiteth
 * SCR(s) 3558 :
 * Remove hardware register access macros.  Now in hwconfig.h.
 * 
 * 
 *    Rev 1.107   11 Apr 2002 14:15:18   whiteth
 * SCR(s) 3543 :
 * Changed BITFIELD #define to be in the <chipname>.h header files since
 ...
 * 
 * 
 *    Rev 1.106   10 Apr 2002 16:15:42   whiteth
 * SCR(s) 3509 :
 * Eradicate external bus (PCI) bitfield usage.
 * 
 *
 *    Rev 1.105   05 Apr 2002 14:19:36   whiteth
 * SCR(s) 3510 :
 * Backout DCS #3468
 * 
 *    Rev 1.104   03 Apr 2002 10:16:22   dawilson
 * SCR(s) 3494 :
 * Fixed CNXT_REG_SET, CNXT_REG_GET, CNXT_FLAG_SET and CNXT_FLAG_GET macros.
 * Previous versions did not include correct parentheses in definition causing
 * macros to expand incorrectly in cases where the passed parameters were
 * complex expressions rather than single values.
 *
 *    Rev 1.103   28 Mar 2002 14:09:20   rutherq
 * SCR(s) 3468 :
 * Masks have been defined for the previously used bitfields.  These
 * bit field definitions still exist for now.  Also added CNXT_FLAG_GET and
 * CNXT_FLAG_SET macros.
 *
 *    Rev 1.102   04 Mar 2002 17:49:20   whiteth
 * SCR(s) 3299 :
 * Add ATA_TYPE definition and misc req'd for ATA driver.
 *
 *    Rev 1.101   04 Mar 2002 16:09:48   whiteth
 * SCR(s) 3296 :
 * Added PLL_DIV2_ definitions for defect DCS #3286 which weren't dropped.
 *
 *    Rev 1.100   21 Feb 2002 16:21:54   whiteth
 * SCR(s) 3229 :
 * Use NUM_PARSERS definition for DPS_NUM_DEMUXES.
 * 
 *    Rev 1.99   11 Jan 2002 10:45:34   mooreda
 * SCR(s) 3006 :
 * added SDRAM 64MB_256, changed 32MB_64 to 32MB_128
 * 
 *    Rev 1.98   11 Jan 2002 10:34:14   bintzmf
 * SCR(s) 3027 :
 * Deleted generic_reg_set/get macro and replaced it with cnxt_reg_set/get
 * 
 *    Rev 1.97   08 Jan 2002 12:07:56   velusws
 * SCR(s) 2998 :
 * Added defines for CONFIG1 & SW_PWR registers & new defines for ALT_FUNC bit values
 * 
 *    Rev 1.96   19 Dec 2001 16:26:08   vangulr
 * SCR(s) 2977 :
 * Fix another missing prameter on a macro
 * 
 *    Rev 1.95   19 Dec 2001 10:28:14   vangulr
 * SCR(s) 2977 :
 * Fix a couple macro definitions that had the incorrect number of parameters
 * 
 *    Rev 1.94   19 Dec 2001 09:17:52   rossst
 * SCR(s) 2933 :
 * Changed duplicate HSDP_PORT_MODE_1394_READ to HSDP_PORT_MODE_1394_WRITE.
 * 
 *    Rev 1.93   18 Dec 2001 14:49:34   bintzmf
 * SCR(s) 2933 :
 * Added Traceport define, HSDP register definitions, and other merges from wabash branch
 * 
 *    Rev 1.92   18 Dec 2001 09:50:14   vangulr
 * SCR(s) 2977 :
 * Changes to support new multi-instance demux driver
 * 
 *    Rev 1.91   29 Nov 2001 18:04:54   rutherq
 * SCR(s) 2933 :
 * Added a define for a colorado bug with the IR input being inverted.
 * See the hardware Errata on Colorado for details on this bug.
 * 
 *    Rev 1.90   29 Nov 2001 14:24:10   kortemw
 * SCR(s) 2937 :
 * Set bit 3 of 0x30000020 for Colorado Rev D1
 * so that arbitration between GXA and Pawser on
 * hsx bus happens.
 * 
 *    Rev 1.89   29 Nov 2001 12:59:30   bintzmf
 * SCR(s) 2936 :
 * added extra pci config register offsets
 * 
 *    Rev 1.88   07 Nov 2001 15:47:32   dawilson
 * SCR(s) 2872 :
 * Added definition of MPG_COMMAND_FLUSH_VBV
 * 
 *    Rev 1.87   Nov 07 2001 14:17:54   bradforw
 * SCR(s) 2753 :
 * Added definition of PLL_TYPE for CODELDR changes
 * 
 *    Rev 1.86   Oct 29 2001 14:06:54   bradforw
 * SCR(s) 2828 :
 * Changed basetype.h typedef references (e.g. u_int32) to hwconfig.h typedef
 * references (e.g. HW_DWORD) to avoid problems with undefined or conflicting
 * typedefs since hwconfig.h now includes boxcfg.h, which includes "chip.h"
 * 
 *    Rev 1.85   17 Oct 2001 09:11:54   whiteth
 * SCR(s) 2799 :
 * Added N3 ICAM function.
 * 
 *    Rev 1.84   06 Sep 2001 13:50:04   whiteth
 * SCR(s) 2592 :
 * Added Per-Slot-PSI/PES buffer support for the new microcodes
 * built with -dMULTI_PSI.  In the source tree, these microcodes
 * are denoted with a "p" (e.g. dvb_anp.c is the Colorado version
 * of BSkyB NDS Per-Slot-PSI micrcode).
 * 
 *    Rev 1.83   16 Jul 2001 12:09:24   rutherq
 * SCR(s) 2298 2299 2300 2301 2302 :
 * Added a MPEG_CORE_RESET_HIGH definition for the video reset sequence to use.
 * 
 *    Rev 1.82   12 Jul 2001 11:53:06   whiteth
 * SCR(s) 2261 2259 2260 :
 * Allow forward compatibility with multi-instance DMX HW support
 * in Hondo.  The changes made with this defect are begign to any
 * code which includes this header file for building with the
 * colorado chip.
 *
 *    Rev 1.81   10 Jul 2001 17:33:02   dawilson
 * SCR(s) 2238 2237 :
 * Changed definitions of video decode buffers (MPG_VID_P_COMPLETE, etc) to match latest video microcode drop.
 *
 *    Rev 1.80   03 Jul 2001 09:43:20   whiteth
 * SCR(s) 2178 2179 2180 :
 * Merge branched Hondo specific code back into the mainstream source database.
 * 
 *    Rev 1.79.1.1   29 Jun 2001 13:34:06   prattac
 * SCR(s) 1642 :
 * Merging previous unintentional branch.
 * Removed defines for AUDIO_MICROCODE, VIDEO_MICROCODE, and PAWSER_MICROCODE.
 * These now belong in cx2249x.cfg.
 * 
 *    Rev 1.79.1.0.1.0   28 Jun 2001 15:56:30   prattac
 * SCR(s) 1642 :
 * Removed definitions for VIDEO_MICROCODE, AUDIO_MICROCODE, and PAWSER_MICROCODE.
 * These belong in CX2249X.cfg instead.
 * 
 *    Rev 1.79.1.0   27 Jun 2001 17:44:14   mooreda
 * SCR(s) 2162 :
 * Added HAS_PCI32 == NO definition.
 * 
 *    Rev 1.79   11 May 2001 10:42:50   whiteth
 * DCS#1894/1895/1896 -- Changed MPG_COMMAND_PAUSE from 0x28 to 0x1028.
 *
 *    Rev 1.78   20 Apr 2001 11:13:44   dawilson
 * DCS1124: Major changes to video memory management to get Sky Text app running
 *
 *    Rev 1.77   18 Apr 2001 16:32:18   prattac
 * DCS1642 Added chip feature definitions in preparation for new Hondo code.
 * 
 *    Rev 1.76   30 Jan 2001 11:00:18   whiteth
 * DCS#1011: Set DAA_DIV register.
 * 
 *    Rev 1.75   07 Dec 2000 11:53:00   mustafa
 * Added definition of MPG_AUD_SYNC_ENABLED
 * 
 *    Rev 1.74   12 Oct 2000 13:28:50   rossst
 * Corrected PLL_PIN_MUXSEL structure for rev A & B to match hardware.
 * 
 *    Rev 1.73   06 Oct 2000 17:28:22   rossst
 * Added pin muxing definitions for redirecting UART2 through the 
 * smartcard pins.
 * 
 *    Rev 1.72   05 Oct 2000 17:42:56   whiteth
 * Added encode buffer low-water mark registers.
 * 
 *    Rev 1.71   27 Sep 2000 17:41:18   velusws
 * New Register acros for dual banks of Smartcard registers.
 * 
 *    Rev 1.70   26 Sep 2000 17:05:06   whiteth
 * Added switchable secondary descriptor capability to low-level flash function.
 * 
 *    Rev 1.69   15 Sep 2000 14:46:38   achen
 * Added definitions for absolute values writting to registers for pulse timer.
 * 
 *    Rev 1.68   08 Sep 2000 16:39:26   whiteth
 * Fixed typo in ATA_UDMA register definition.
 * 
 *    Rev 1.67   07 Sep 2000 19:14:04   velusws
 * Added Macros to read a GPIO pin's Value
 * 
 *    Rev 1.66   07 Sep 2000 18:37:44   whiteth
 * Updated ATA subsystem definitions.
 *
 *    Rev 1.65   06 Sep 2000 18:35:54   velusws
 * Added PLL_PIN_SC1_PWR_REG
 *
 *    Rev 1.64   06 Sep 2000 17:04:42   whiteth
 * Added RST ASB memory instruction prefetch enable mechanism.
 *
 *    Rev 1.63   05 Sep 2000 10:01:10   whiteth
 * Updated pin mux hardware interface for Rev C.
 * 
 *    Rev 1.62   15 Aug 2000 14:37:06   dawilson
 * Replaced critical section calls in GPIO macros with HWLIB versions. The
 * previous level of the header used OTVKAL equivalents instead
 * 
 *    Rev 1.61   26 Jul 2000 11:37:10   whitey
 * Added DVR PTS event source type definitions.
 * 
 *    Rev 1.60   14 Jul 2000 16:29:34   mustafa
 * Added DPS defines for CANAL PLUS filtering.
 * 
 *    Rev 1.59   29 Jun 2000 12:07:40   dawilson
 * Added module flag for RST component
 * 
 *    Rev 1.58   21 Jun 2000 16:31:58   whiteth
 * Added Colorado Rev_C changes (pin muxing changes).
 * 
 *    Rev 1.57   01 Jun 2000 16:53:54   whiteth
 * Fixed bug in DVR_EVENT block layout...
 * 
 *    Rev 1.56   25 May 2000 17:11:20   whiteth
 * Added a few more DVR details...
 * 
 *    Rev 1.55   24 May 2000 17:01:50   mooreda
 * Revised DMA to reflect current CX2249X silicon.
 * 
 *    Rev 1.54   24 May 2000 15:47:02   whiteth
 * Fixed compiler warning...
 * 
 *    Rev 1.53   24 May 2000 15:35:24   whiteth
 * Added DVR definitions, datatypes, and buffer size/location #defines.
 *
 *    Rev 1.52   15 May 2000 17:33:32   velusws
 * Defined SER_NUM_PORTS and Frame Control Register aliases
 *
 *    Rev 1.51   15 May 2000 16:36:48   velusws
 * Added SER_FIFO_DEPTH
 *
 *    Rev 1.50   12 May 2000 14:52:46   achen
 * Added PLL_RTC_DIV_54MHz_TO_1HZ.
 * 
 *    Rev 1.49   11 May 2000 17:17:34   velusws
 * added definition for TX/RX FIFO Status registers
 * 
 *    Rev 1.48   10 May 2000 18:30:34   velusws
 * Added definition  and Macros for Uart IRLVL register
 * 
 *    Rev 1.47   04 May 2000 11:14:36   mustafa
 * Fixed ESR bits which were incorrect in the SPEC.
 * 
 *    Rev 1.46   02 May 2000 16:54:02   mustafa
 * MPEG Error Mask register bit 0 is the real bitstream error bit.
 * Documentation was wrong.
 * 
 *    Rev 1.45   02 May 2000 16:28:32   dawilson
 * Added fix to MAKE_GPIO_INPUT for Colorado Rev A bug
 * 
 *    Rev 1.44   01 May 2000 16:20:18   dawilson
 * Corrected PWN control register definition
 * 
 *    Rev 1.43   28 Apr 2000 14:42:12   whiteth
 * Fixed SDR_RANK_32MB_128 definitions to match HW.
 * 
 *    Rev 1.42   28 Apr 2000 10:23:08   dawilson
 * Corrected definitions of PCI_ROM_MODE_REG
 * 
 *    Rev 1.41   26 Apr 2000 10:22:50   whiteth
 * Make Colorado UART changes consistent between .h and .a files.
 * 
 *    Rev 1.40   26 Apr 2000 09:52:46   dawilson
 * Fixed typos in some new serial register macros
 * 
 *    Rev 1.39   26 Apr 2000 00:22:16   whiteth
 * Colorado uses UART3.
 * 
 *    Rev 1.38   24 Apr 2000 21:31:56   whiteth
 * Removed the RSO_ definitions from chip specific header file and
 * placed into vendor/board specific header file.
 * 
 *    Rev 1.37   24 Apr 2000 10:17:20   whiteth
 * Moved strapping CONFIG0 from chip header file(s) to board header file(s).
 * 
 *    Rev 1.36   12 Apr 2000 14:55:36   dawilson
 * Changed definition of PLL_CONFIG0 to use a union describing the different
 * possibilities for the register.
 * 
 *    Rev 1.35   10 Apr 2000 17:35:06   rtilton
 * Added the bit defines for the last decoded mpg buffer.
 * 
 *    Rev 1.34   10 Apr 2000 17:21:40   mustafa
 * Added defines for Control Reg 0 for non bitfield code.
 * 
 *    Rev 1.33   31 Mar 2000 18:11:44   mustafa
 * Removed all NDS ICAM related things.
 * 
 *    Rev 1.32   31 Mar 2000 16:05:32   eching
 * Updated GXA definitions to match up with specification.
 * 
 *    Rev 1.31   30 Mar 2000 16:07:58   dawilson
 * Updated PWM registers and changed name of PLL_GPIO_MUX_REG to match spec
 * 
 *    Rev 1.30   22 Mar 2000 16:26:20   whiteth
 * Removed old IOCHRDY bits and replaced with ExtWait:2 which is valid for both
 * Colorado and all Neches (A&B) chips according to the specs.
 * 
 *    Rev 1.29   17 Mar 2000 16:08:50   whiteth
 * Added ATA register descriptions to the PCI section.
 * 
 *    Rev 1.28   08 Mar 2000 14:09:52   eching
 * Fixed incorrect values for 32 bpp OSD pixel type definitions.
 * 
 *    Rev 1.27   03 Mar 2000 13:45:26   rossst
 * Added SER_TX/RX_FIFO_STATUS_REG/(x) definitions for the 
 * serial port FIFO status registers.
 * 
 *    Rev 1.26   02 Mar 2000 17:27:02   whiteth
 * Added Colorado Chip/Rev ID #define's.
 * 
 *    Rev 1.25   29 Feb 2000 19:05:14   velusws
 * new defines to Enable ICAM PinMux
 * 
 *    Rev 1.24   18 Feb 2000 17:20:00   mustafa
 * Added more defines to remove bitfields.
 * 
 *    Rev 1.23   08 Feb 2000 18:08:24   mustafa
 * Added DSP SWAP bit.
 * 
 *    Rev 1.22   04 Feb 2000 14:40:32   mustafa
 * Added defines for no bit field changes.
 * 
 *    Rev 1.21   01 Feb 2000 16:08:08   mustafa
 * Changed GPI bank size from 0x100 to 0x30.
 *
 *    Rev 1.20   31 Jan 2000 16:03:34   mustafa
 * More DPS changes. PidTidEnable register removed.
 *
 *    Rev 1.19   25 Jan 2000 17:48:34   prattac
 * Updated MPG section to match the 1/17 Colorado Spec.  Removed
 * definitions that do not apply to Colorado.
 *
 *    Rev 1.18   24 Jan 2000 10:58:30   rossst
 * Updated SDR_RANK0/1_SIZE.
 * Corrected ARM_DBG_COMM WriteRdy to WriteBsy.
 *
 *    Rev 1.17   21 Jan 2000 10:31:52   velusws
 * Restored CAM register bit position definitions
 *
 *    Rev 1.16   21 Jan 2000 10:21:04   velusws
 * Added CAM_CONFIG_OUT Reg, updated address for
 * - CAM0_ENABLE Reg.
 * Replaced CAM bit position definitions with Bit-field definitions.
 *
 *    Rev 1.15   20 Jan 2000 15:09:00   rtilton
 * The upper 3 bits of the OSD field 1 address have been moved to the MSB of
 * OSD field 2.
 *
 *    Rev 1.14   20 Jan 2000 14:56:48   mustafa
 * Cleanup Old key enable and PAWSER stuff.
 *
 *    Rev 1.13   12 Jan 2000 14:46:08   rossst
 * Added resistor strapping config register changes for COlorado.
 *
 *    Rev 1.12   11 Jan 2000 19:24:06   prattac
 * Removed definitions of MPG registers that have moved to DPS
 *
 *    Rev 1.11   11 Jan 2000 18:22:52   rossst
 * Added SDRAM changes for Colorado.
 *
 *    Rev 1.10   11 Jan 2000 15:38:58   rossst
 * Added debug comm port definition to ARM section.
 *
 *    Rev 1.9   10 Jan 2000 16:58:08   mustafa
 * Fixed incorrect define for shift value of ECM enable.
 *
 *    Rev 1.8   06 Jan 2000 17:08:20   eching
 * Added some new defines for 32 bit access to GXA config registers.
 *
 *    Rev 1.7   06 Jan 2000 13:29:52   rtilton
 * Added Colorado DRM register definitions.
 *
 *    Rev 1.6   03 Jan 2000 09:25:44   mustafa
 * More PAWSER stuff.
 *
 *    Rev 1.5   08 Dec 1999 17:11:24   rossst
 * Added changes for Colorado.
 *
 *    Rev 1.4   01 Dec 1999 15:01:28   eching
 * Added definitions for graphics acceleration.
 *
 *    Rev 1.3   01 Dec 1999 14:23:02   mustafa
 * More Parser stuff.
 *
 *    Rev 1.2   29 Nov 1999 17:19:08   mustafa
 * Added new Parser definitions.
 *
 *    Rev 1.1   29 Oct 1999 09:07:24   dawilson
 * Added RST_LOWPOWER_REG
 *
 *    Rev 1.0   12 Oct 1999 10:54:16   dawilson
 * Initial revision.
 *
 ****************************************************************************/
