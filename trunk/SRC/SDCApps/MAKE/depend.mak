...
# It is important that there is no space in the echo command or it'll break NMAKE.  See CR 8152
	...
	-f$(SABINE_ROOT)\$(DRIVER)\$(INTER_OUTPUT_DIR)\$@ $(<) 
...
#****************************************************************************
#* $Log:
#*  2    mpeg      1.1         7/9/2004 4:52:07 PM    Xiao Guang Yan  CR(s)
#*       9699 9700 : Removed unnecessary definitions.
#*  1    mpeg      1.0         7/5/2004 7:07:58 PM    Ford Fu         CR(s)
