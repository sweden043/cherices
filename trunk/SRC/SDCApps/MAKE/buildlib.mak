...
library:
	@echo ---- ---- Creating library $(DRIVER).LIB 
	$(AT)$(LIBR) $(LIBRFLAGS) $(LIB_OUTPUT_DIR)\$(DRIVER).LIB $(DEPENDENCY_LIST)
...
#****************************************************************************
#* $Log:
#*  2    mpeg      1.1         7/9/2004 4:37:37 PM    Xiao Guang Yan  CR(s)
#*       9699 9700 : Changed OUTPUT_DIR to SDCAPPS_OUTPUT_DIR to avoid
#*       confusion.
#*  1    mpeg      1.0         7/5/2004 7:05:40 PM    Ford Fu         CR(s)
