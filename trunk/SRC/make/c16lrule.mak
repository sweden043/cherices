...
CDEFS  = -DBSP_LITTLE_ENDIAN=1 -DCONFIG=$(CONFIG) -DCUSTOMER=$(CUSTOMER) -DRVERSION=$(VERSION) -DARM_VERSION=$(ARM_VERSION) -DRTOS=$(RTOS) -D__thumb=1
...
COPTS  = $(CFLAGS) $(CDEBUG) $(CDEFS) $(EXTRA_THUMB_C_FLAGS) -via $(SABINE_ROOT)\$(APPNAME).CFL  
...
.cpp{$(SABINE_ROOT)\$(DRIVER)\$(CONFIG)\$(APPNAME)\$(RTOS)\$(SWCONFIG)\$(DEBUGDIR)\}.obj:
 @echo ---- Compiling THUMB mode $(*B).cpp
