...
##########################################
!if "$(ARM_TOOLKIT)" == "ADS"               # . ARM_TOOLKIT
AFLAGS = -32 -I$(INC_FIX:;= -I) -apcs /noswst/inter -li -fpu softfpa -cpu ARM9TDMI
!elseif "$(ARM_TOOLKIT)" == "SDT"           # . ARM_TOOLKIT
!if "$(ARM_VERSION)" == "250"               # .. ARM_VERSION
AFLAGS = -32 -I$(INC_FIX:;= -I) -apcs 3/32/nofp/noswst -li -cpu ARM9TDMI
!elseif "$(ARM_VERSION)" == "251"           # .. ARM_VERSION
AFLAGS = -32 -I$(INC_FIX:;= -I) -apcs 3/32/nofp/noswst -li -cpu ARM9TM
!endif                                      # .. ARM_VERSION
!endif                                      # . ARM_TOOLKIT
...
AOPTS  = $(AFLAGS) $(EXTRA_ARM_ASM_FLAGS) $(ADEBUG) $(ADEFS) $(ASM_CONFIG_FLAGS)
