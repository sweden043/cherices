 ...
 *                  for IRD central IC codenamed Hondo.
 *
 *
 * Author:          Tim Ross
 *
 ****************************************************************************/
/* $Header: hondo.h, 109, 3/10/04 10:41:34 AM, Bob Van Gulick$
 ****************************************************************************/
...
#define GPIO_CONFIG             GPIOM_HONDO
...
#define         ENC_CTL0_BLUEFIELD_ENABLE                            (1UL<<8)
...
#define ITC_EXTVIDEOACTIVE 0x00000020
#define ITC_EXTVIDEOBLANK  0x00000040
#define ITC_AUDIORX        0x00000080
#define ITC_AUDIOTX        0x00000100
#define ITC_PARALLEL       0x00000200
...
#define ITC_EXTVIDEOACTIVE_POS   5
#define ITC_EXTVIDEOBLANK_POS    6
#define ITC_AUDIORX_POS          7
#define ITC_AUDIOTX_POS          8
#define ITC_PARALLEL_POS         9
...
#define PCI_ATA_CS(cs)                             ((1<<(cs))<<PCI_ATA_CS_SHIFT)
...
/* last updated 4/17/01 to match 4/16 Hondo Spec */
#ifdef INCL_MPG
...
#define     HSDP_SPLICE_CTRL_SER_NIM_PORT_1_MASK                   0x00000002
#define     HSDP_SPLICE_CTRL_SER_NIM_PORT_1_SHIFT                         1
#define         HSDP_SPLICE_CTRL_SER_NIM_PORT_1_ENABLE              (1UL<<1)
...
#define     HSDP_SPLICE_STATUS_SER_NIM_PORT_1_MASK                 0x00000200
#define     HSDP_SPLICE_STATUS_SER_NIM_PORT_1_SHIFT                       9
#define         HSDP_SPLICE_STATUS_SER_NIM_PORT_1_ENABLE             (1UL<<9)
 ...
 *******************************************************************************
 *
 *  There are three mapping sections each with a header.  For Hondo, there
...
#define     DPS_PVR_EVENT_INTR_MASK                                0x00000040
#define     DPS_PVR_EVENT_INTR_SHIFT                                      6
#define         DPS_PVR_EVENT_INTR                                   (1UL<<6)
...
#define     DPS_PVR_EVENT_FULL_MASK                                0x00000080
#define     DPS_PVR_EVENT_FULL_SHIFT                                      7
#define         DPS_PVR_EVENT_FULL                                   (1UL<<7)
...
/* to incorporate DMA changes in Hondo chip */
 ...
 * Modifications:
 * $Log: 
 *  109  mpeg      1.108       3/10/04 10:41:34 AM    Bob Van Gulick  CR(s) 
 *        8546 : Add support to return PES frame rate
 *  108  mpeg      1.107       2/24/04 2:42:46 PM     Bob Van Gulick  CR(s) 
 *        8427 : Add timebase_offset functionality to demux
 *        
 *  107  mpeg      1.106       2/11/04 8:40:26 AM     Steven Jones    CR(s) 
 ...
 *  106  mpeg      1.105       9/19/03 6:48:20 PM     Dave Aerne      SCR(s) 
 *        7514 :
 *        cleanup to map CORE_RESET defines to standard CONTROL0 defines
 *        
 *  105  mpeg      1.104       8/18/03 2:32:12 PM     Miles Bintz     SCR(s) 
 *        7291 :
 *        added mmy type definitions
 *        
 *  104  mpeg      1.103       6/9/03 5:57:04 PM      Bob Van Gulick  SCR(s) 
 *        6755 :
 ...
 *        
 *        
 *  103  mpeg      1.102       5/2/03 11:14:20 AM     Bob Van Gulick  SCR(s) 
 *        6151 :
 *        Add pts_offset and dma_mux memory locations
 *        
 *        
 *  102  mpeg      1.101       3/13/03 12:22:06 PM    Miles Bintz     SCR(s) 
 *        5753 :
 *        Added HSDP_BIDIR_PORT_CNTL_SER_TO_PAR_CONV_DISABLE definition to chip
 *         header file
 *        
 *        
 *  101  mpeg      1.100       3/5/03 3:51:14 PM      Miles Bintz     SCR(s) 
 *        5634 :
 *        added CHIP_SUPPORTS_PIO_TIMED_RESET feature definition to chip header
 *         files
 *        
 *        
 *  100  mpeg      1.99        2/28/03 11:15:32 AM    Dave Aerne      SCR(s) 
 *        4672 :
 *        for audio AUTO_DETECT feature, added DPS_AUDIO_PID_STREAM_ID_EX at 
 *        address
 *        DPS_BASE + 0x1FC
 *        
 *  99   mpeg      1.98        2/4/03 5:07:46 PM      Bob Van Gulick  SCR(s) 
 *        5407 :
 *        Change scrambling status to use separate TS and PES registers
 *        
 *        
 *  98   mpeg      1.97        1/15/03 3:51:26 PM     Billy Jackman   SCR(s) 
 *        5095 :
 *        Added specification of INTERNAL_DEMOD as NOT_PRESENT.
 *        
 *  97   mpeg      1.96        12/17/02 3:56:16 PM    Tim White       SCR(s) 
 *        5182 :
 *        Remove ARM_PIT_TYPE, no longer needed.  Added HAS_WB_CACHE_BUG to 
 *        ensure WB cache
 *        is never enabled on a Hondo since it's pre-Rev_2 ARM940.  Added 
 *        default ASB_MODE value.
 *        
 *        
 *  96   mpeg      1.95        12/12/02 5:15:18 PM    Tim White       SCR(s) 
 *        5157 :
 *        Removed ISHONDO macro (moved to hwconfig.h along with the others).  
 *        Removed the PCI_ROM_MODE_REG_TYPE def'n.
 *        
 *        
 *  95   mpeg      1.94        12/10/02 1:59:08 PM    Bob Van Gulick  SCR(s) 
 *        5121 :
 *        Add scrambler status memory location for demux
 *        
 *        
 *  94   mpeg      1.93        12/6/02 5:12:32 PM     Dave Wilson     SCR(s) 
 *        4903 :
 *        Added new chip features to differentiate some DRM function changes in
 *         Brazos
 *        
 *  93   mpeg      1.92        10/30/02 2:46:14 PM    Bobby Bradford  SCR(s) 
 *        4866 :
 ...
 *        
 *  92   mpeg      1.91        10/21/02 4:47:10 PM    Senthil Veluswamy SCR(s) 
 *        4790 :
 *        added define for the Audio AC3 Align Error
 *        
 *  91   mpeg      1.90        10/11/02 12:20:44 PM   Miles Bintz     SCR(s) 
 *        4431 :
 *        Added config option for hsx arbiter type
 *        
 *        
 *  90   mpeg      1.89        9/18/02 5:25:28 PM     Joe Kroesche    SCR(s) 
 *        4610 :
 *        added DPS_ macro needed for crc notification feature
 *        
 *  89   mpeg      1.88        9/17/02 5:49:42 PM     Carroll Vance   SCR(s) 
 *        4613 :
 *        Added HAS_INTERNAL_PCI32 and HAS_EXTERNAL_PCI32
 *        
 *  88   mpeg      1.87        8/30/02 6:34:52 PM     Senthil Veluswamy SCR(s) 
 *        4502 :
 *        Defines for using the New IIC interface
 *        
 *  87   mpeg      1.86        8/30/02 3:02:52 PM     Larry Wang      SCR(s) 
 *        4499 :
 *        Define INTEXP_TYPE as NOT_PRESENT.
 *        
 *  86   mpeg      1.85        8/30/02 2:40:26 PM     Bob Van Gulick  SCR(s) 
 *        4485 :
 *        Add defines to support CRC checking in demux driver
 *        
 *        
 *  85   mpeg      1.84        8/22/02 6:02:42 PM     Brendan Donahe  SCR(s) 
 *        4464 :
 ...
 *        
 *        
 *  84   mpeg      1.83        8/22/02 4:03:24 PM     Larry Wang      SCR(s) 
 *        4459 :
 *        Define PCI_ROM_MODE_REG_TYPE.
 *        
 *  83   mpeg      1.82        8/15/02 7:22:32 PM     Tim Ross        SCR(s) 
 *        4409 :
 *        Moved all default feature defnitions here from hwconfig. Also moved 
 *        ISHONDO macro here from startup.h.
 *        
 *  82   mpeg      1.81        8/15/02 3:54:58 PM     Tim White       SCR(s) 
 *        4398 :
 *        Removed the #define's for ULTRAxxxxx.
 *        
 *        
 *  81   mpeg      1.80        8/14/02 4:55:06 PM     Dave Wilson     SCR(s) 
 *        4371 :
 *        Corrected definition of DRM_COLOR_KEY_REG contents. Should be 24 bits
 *         +
 *        8 reserved bits rather than 16 + 16 reserved.
 *        
 *  80   mpeg      1.79        6/14/02 11:08:14 AM    Carroll Vance   SCR(s) 
 *        3786 :
 ...
 *        
 *  79   mpeg      1.78        6/13/02 10:54:48 AM    Carroll Vance   SCR(s) 
 *        3786 :
 *        Turned off use of DRM bitfields.
 *        
 *  78   mpeg      1.77        6/6/02 5:54:32 PM      Craig Dry       SCR(s) 
 *        3923 :
 *        Remove MPG bitfields conditionally - Step 1
 *        
 *  77   mpeg      1.76        6/3/02 2:49:16 PM      Craig Dry       SCR(s) 
 *        3922 :
 *        Conditionally remove SYN bitfield structures from header files
 *        
 *  76   mpeg      1.75        6/3/02 12:52:14 PM     Carroll Vance   SCR(s) 
 *        3918 :
 *        Forgot to change one use of PLL_LOCK_CMD to PLL_LOCK_CMD_VALUE. Fixed
 *         it.
 *        
 *  75   mpeg      1.74        6/3/02 12:43:46 PM     Carroll Vance   SCR(s) 
 *        3918 :
 ...
 *        
 *  74   mpeg      1.73        5/31/02 7:29:02 PM     Craig Dry       SCR(s) 
 *        3916 :
 *        Eradicate bitfield use from AFE code
 *        
 *  73   mpeg      1.72        5/31/02 12:09:22 PM    Craig Dry       SCR(s) 
 *        3908 :
 *        Eradicate bitfield use from Smart Card(SMC) code, step 1
 *        
 *  72   mpeg      1.71        5/30/02 12:32:56 PM    Tim White       SCR(s) 
 *        3899 :
 *        Add WARM_RESET support.
 *        
 *        
 *  71   mpeg      1.70        5/22/02 5:42:18 PM     Craig Dry       SCR(s) 
 *        3855 :
 *        Eradicate bitfield use from SER(Serial) code, step 1
 *        
 *  70   mpeg      1.69        5/21/02 2:05:54 PM     Tim White       SCR(s) 
 *        3642 :
 *        Add DPS_PCR_BLOCK_STORED bit definition for new pawser microcode 
 *        build option -dPCR_PID_INT.
 *        
 *        
 *  69   mpeg      1.68        5/21/02 1:32:38 PM     Carroll Vance   SCR(s) 
 *        3786 :
 *        Added LPREG in front of DRM register addresses.
 *        
 *  68   mpeg      1.67        5/20/02 12:55:22 PM    Steve Glennon   SCR(s): 
 *        3830 
 *        Changed the CONTROL1 bitfield Reserved2 field to HaltDecode to match 
 *        colorado.h
 *        
 *        
 *  67   mpeg      1.66        5/17/02 12:17:42 PM    Craig Dry       SCR(s) 
 *        3810 :
 *        Eradicate bitfield use from IRD code
 *        
 *  66   mpeg      1.65        5/15/02 3:09:10 PM     Craig Dry       SCR(s) 
 *        3794 :
 *        Eradicate bitfields from PAR module
 *        
 *  65   mpeg      1.64        5/15/02 2:56:16 PM     Carroll Vance   SCR(s) 
 *        3786 :
 *        Added constants for DRM bitfields.
 *        
 *  64   mpeg      1.63        5/15/02 12:19:34 PM    Carroll Vance   SCR(s) 
 *        3789 1238924 :
 *        Clean up audio bitfield masks.
 *        
 *  63   mpeg      1.62        5/14/02 5:24:04 PM     Craig Dry       SCR(s) 
 *        3784 :
 *        Eradicate bitfields from PWM(Pulse Width Modulator)
 *        
 *  62   mpeg      1.61        5/14/02 11:45:34 AM    Craig Dry       SCR(s) 
 *        3776 :
 *        Eradicate bitfield use from PLS(Pulse Timer), step 1
 *        
 *  61   mpeg      1.60        5/13/02 1:55:44 PM     Tim White       SCR(s) 
 *        3760 :
 *        Updated DPS_ definition section.
 *        
 *        
 *  60   mpeg      1.59        5/10/02 3:19:50 PM     Craig Dry       SCR(s) 
 *        3754 :
 *        Eradicate bitfield use from SDR(SDRAM) code
 *        
 *  59   mpeg      1.58        5/7/02 5:58:14 PM      Craig Dry       SCR(s) 
 *        3726 :
 *        Eradicate bitfield use from I2C, step 1
 *        
 *  58   mpeg      1.57        5/7/02 5:10:10 PM      Tim White       SCR(s) 
 *        3721 :
 *        Remove ENC_ bitfield usage from codebase.
 *        
 *        
 *  57   mpeg      1.56        5/6/02 5:59:36 PM      Tim White       SCR(s) 
 *        3714 :
 *        Update HSDP_ macro definitions to use new bitfield-less format.
 *        
 *        
 *  56   mpeg      1.55        5/3/02 3:49:22 PM      Craig Dry       SCR(s) 
 *        3671 :
 *        Eradicate bitfield use from TIM module
 *        
 *  55   mpeg      1.54        5/3/02 2:47:02 PM      Tim White       SCR(s) 
 *        3696 :
 *        Remove RST_ bitfields from codebase.
 *        
 *        
 *  54   mpeg      1.53        5/3/02 1:56:48 PM      Dave Wilson     SCR(s) 
 *        3688 :
 *        Added definitions of new parser events used to detect data on audio 
 *        and 
 *        video PIDs.
 *        
 *  53   mpeg      1.52        5/2/02 5:25:42 PM      Tim White       SCR(s) 
 *        3693 :
 *        Use "UL" in the macro bit definitions to force unsigned and fix 
 *        compiler warnings.
 *        
 *        
 *  52   mpeg      1.51        5/1/02 7:00:20 PM      Carroll Vance   SCR(s) 
 *        3659 :
 *        Removed audio bitfield types.
 *        
 *  51   mpeg      1.50        5/1/02 5:45:08 PM      Tim White       SCR(s) 
 *        3678 :
 *        Remove GCP_ & ARM_ bitfields usage from the codebase.
 *        
 *        
 *  50   mpeg      1.49        5/1/02 3:30:50 PM      Tim White       SCR(s) 
 *        3673 :
 *        Remove PLL_ bitfields usage from codebase.
 *        
 *        
 *  49   mpeg      1.48        4/30/02 5:38:08 PM     Joe Kroesche    SCR(s) 
 *        3243 :
 *        added definition for new parser event bit (bad PES header)
 *        
 *  48   mpeg      1.47        4/30/02 4:20:20 PM     Craig Dry       SCR(s) 
 *        3662 :
 *        Use same build configurations as were used to test defect 3509. 
 *        
 *  47   mpeg      1.46        4/30/02 2:56:08 PM     Carroll Vance   SCR(s) 
 *        3659 :
 *        Removing bitfields from audio, step 1.
 *        
 *        
 *  46   mpeg      1.45        4/30/02 12:58:54 PM    Billy Jackman   SCR(s) 
 *        3656 :
 *        Changed expression (1<<31) to ((unsigned)1<<31) to avoid compiler 
 *        warning
 *        in SDT toolset.
 *        
 *  45   mpeg      1.44        4/29/02 6:17:10 PM     Craig Dry       SCR(s) 
 *        3652 :
 *        Eliminate bitfield use from Movie (MOV) module by conditional 
 *        compilation.
 *        
 *  44   mpeg      1.43        4/24/02 4:28:02 PM     Dave Wilson     SCR(s) 
 *        3611 :
 *        
 *        
 *        Updated MPG_VID_SIZE_REG bit definitions in line with latest 
 *        microcode.
 *        
 *  43   mpeg      1.42        4/22/02 3:22:20 PM     Larry Wang      SCR(s) 
 *        3585 :
 ...
 *        extender.
 *        
 *  42   mpeg      1.41        4/19/02 5:52:54 PM     Craig Dry       SCR(s) 
 *        3588 :
 *        Conditionally compile out RTC bitfield definitions.
 *        
 *  41   mpeg      1.40        4/18/02 11:10:24 AM    Craig Dry       SCR(s) 
 *        3576 :
 *        GXA bitfield definitions are now conditionally compiled out.
 *        
 *  40   mpeg      1.39        4/12/02 7:50:32 PM     Tim White       SCR(s) 
 *        3558 :
 *        Remove hardware register access macros.  Now in hwconfig.h.
 *        
 *        
 *  39   mpeg      1.38        4/11/02 3:15:22 PM     Tim White       SCR(s) 
 *        3543 :
 ...
 *        
 *        
 *  38   mpeg      1.37        4/10/02 5:15:46 PM     Tim White       SCR(s) 
 *        3509 :
 *        Eradicate external bus (PCI) bitfield usage.
 *        
 *        
 *  37   mpeg      1.36        3/12/02 5:48:56 PM     Tim White       SCR(s) 
 *        3360 :
 *        Use PLL_TYPE_COLORADO for Hondo since it has the same PLL setup as 
 *        Colorado.
 *        
 *        
 *  36   mpeg      1.35        3/4/02 5:49:32 PM      Tim White       SCR(s) 
 *        3299 :
 *        Add ATA_TYPE definition and misc req'd for ATA driver.
 *        
 *        
 *  35   mpeg      1.34        3/1/02 6:47:54 PM      Tim Ross        SCR(s) 
 *        3286 :
 *        Added definitions for Wabash PLL registers.
 *        
 *  34   mpeg      1.33        2/21/02 4:22:02 PM     Tim White       SCR(s) 
 *        3229 :
 *        Use NUM_PARSERS definition for DPS_NUM_DEMUXES.
 *        
 *        
 *  33   mpeg      1.32        2/5/02 2:05:26 PM      Ray Mack        SCR(s) 
 *        3132 :
 *        Duplicated Colorado NIM error label so DEMOD_HW will build correctly.
 *        
 *  32   mpeg      1.31        1/11/02 10:44:16 AM    Dave Moore      SCR(s) 
 *        3006 :
 *        added SDRAM 64MB_256, changed 32MB_64 to 32MB_128
 *        
 *        
 *  31   mpeg      1.30        1/11/02 10:34:20 AM    Miles Bintz     SCR(s) 
 *        3027 :
 *        Deleted generic_reg_set/get macro and replaced it with 
 *        cnxt_reg_set/get
 *        
 *        
 *  30   mpeg      1.29        1/8/02 12:05:16 PM     Senthil Veluswamy SCR(s) 
 *        2998 :
 *        added define for a RTC Clock set value
 *        
 *  29   mpeg      1.28        1/4/02 8:00:28 AM      Senthil Veluswamy SCR(s) 
 *        2998 :
 *        Removed Hard coded Register references
 *        
 *  28   mpeg      1.27        12/19/01 4:27:34 PM    Bob Van Gulick  SCR(s) 
 *        2977 :
 *        Fix another missing prameter on a macro
 *        
 *        
 *  27   mpeg      1.26        12/19/01 10:27:58 AM   Bob Van Gulick  SCR(s) 
 *        2977 :
 *        Fix a couple macro definitions that had the incorrect number of 
 *        parameters
 *        
 *        
 *  26   mpeg      1.25        12/18/01 2:57:16 PM    Miles Bintz     SCR(s) 
 *        2933 :
 *        Merged in changes from wabash branch (HSDP type, uart type, HSDP 
 *        register definitions, etc...)
 *        
 *        
 *  25   mpeg      1.24        12/18/01 9:50:22 AM    Bob Van Gulick  SCR(s) 
 *        2977 :
 *        Changes to support new multi-instance demux driver
 *        
 *        
 *  24   mpeg      1.23        11/29/01 12:59:14 PM   Miles Bintz     SCR(s) 
 *        2936 :
 *        added extra pci config register offsets
 *        
 *  23   mpeg      1.22        11/13/01 12:31:28 PM   QA - Roger Taylor SCR(s) 
 *        2892 :
 *        Added definition of MPG_COMMAND_FLUSH_VBV
 *        
 *  22   mpeg      1.21        11/8/01 3:41:32 PM     Bobby Bradford  SCR(s) 
 *        2753 :
 *        Define PLL_TYPE as HONDO
 *        
 *        
 *  21   mpeg      1.20        10/29/01 2:07:06 PM    Bobby Bradford  SCR(s) 
 *        2828 :
 ...
 *        "chip.h"
 *        
 *  20   mpeg      1.19        10/17/01 10:12:02 AM   Tim White       SCR(s) 
 *        2799 :
 *        Added N3 ICAM function.
 *        
 *        
 *  19   mpeg      1.18        10/9/01 5:30:30 PM     Bobby Bradford  SCR(s) 
 *        2729 :
 *        Modified a few C macro definitions for the DMA macros.  Added a few 
 *        extra ones, as well.  The HONDO DMA registers are slightly different 
 *        than COLORADO, and these differences had not been incorporated into 
 *        the HONDO.H file yet.
 *        
 *  18   mpeg      1.17        9/6/01 2:50:10 PM      Tim White       SCR(s) 
 *        2592 :
 ...
 *        
 *        
 *  17   mpeg      1.16        8/2/01 3:40:56 PM      Angela          SCR(s) 
 *        2430 :
 *        added define MPEG_CORE_RESET_HIGH 
 *        
 *  16   mpeg      1.15        7/13/01 3:06:06 PM     Tim White       SCR(s) 
 *        2281 :
 *        Changed DPS_BASE macro from being a macro concatenation to adding an 
 *        offset.
 *        
 *        
 *  15   mpeg      1.14        7/12/01 5:02:40 PM     Bob Van Gulick  SCR(s) 
 *        2267 :
 *        Add struct's and #defines for Hondo specific ATA code
 *        
 *        
 *  14   mpeg      1.13        7/12/01 12:53:58 PM    Tim White       SCR(s) 
 *        2261 2259 2260 :
 *        Added multi-instance HW DMX register interface.
 *        
 *        
 *  13   mpeg      1.12        6/29/01 2:20:22 PM     Amy Pratt       SCR(s) 
 *        1642 :
 *        Merging in previous unintentional branches.
 *        For SCR 2162:  Added HAS_PCI32 == YES definition.
 *        For SCR 1642:  Removed defines for AUDIO_MICROCODE, VIDEO_MICROCODE, 
 *        and PAWSER_MICROCODE.  They are used by .mak files, so I moved them 
 *        to
 *        cx2249t.cfg and cx2249x.cfg.
 *        
 *        
 *  12   mpeg      1.11        6/13/01 4:32:30 PM     Miles Bintz     SCR(s) 
 *        2084 :
 *        The GENERIC_REG_SET macro was defined incorrectly.  This macro is 
 *        used in ttx_vbi.c for touching
 *        the TV encoder registers.
 *        
 *  11   mpeg      1.10        5/11/01 11:43:24 AM    Tim White       
 *        DCS#1894/1895/1896 -- Changed MPG_COMMAND_PAUSE from 0x28 to 0x1028.
 *        
 *  10   mpeg      1.9         4/27/01 7:26:14 PM     Miles Bintz     added 
 *        hondo built-in encoder structures/macros
 *        
 *  9    mpeg      1.8         4/26/01 6:45:26 PM     Amy Pratt       updated 
 *        HSDP registers (see DPS section.)
 *        
 *  8    mpeg      1.7         4/24/01 4:41:38 PM     Amy Pratt       Re-sync 
 *        with colorado.h
 *        
 *  7    mpeg      1.6         4/22/01 5:17:26 PM     Amy Pratt       Added 
 *        SDRAM Rank 0 Empty bit.
 *        
 *  6    mpeg      1.5         4/18/01 5:33:24 PM     Amy Pratt       DCS1642 
 *        Added chip feature definitions in preparation for new Hondo code.
 *        
 *  5    mpeg      1.4         4/17/01 5:26:00 PM     Amy Pratt       Updated 
 *        MPG section to 4/16 spec.
 *        
 *  4    mpeg      1.3         4/17/01 3:55:02 PM     Amy Pratt       Updated 
 *        MPG section to match 3/5 Hondo spec.
 *        
 *  3    mpeg      1.2         4/16/01 5:31:10 PM     Amy Pratt       Updated 
 *        pin muxing and PLL definitions to match Hondo spec.
 *        
 *  2    mpeg      1.1         3/19/01 4:11:48 PM     Tim Ross        DCS966. 
 *        Started adding some feature definitions.
 *        
 *  1    mpeg      1.0         2/1/01 1:11:14 PM      Tim Ross        
 * $
 * 
 *    Rev 1.105   19 Sep 2003 17:48:20   aernedj
 * SCR(s) 7514 :
 * cleanup to map CORE_RESET defines to standard CONTROL0 defines
 * 
 *    Rev 1.104   18 Aug 2003 13:32:12   bintzmf
 * SCR(s) 7291 :
 * added mmy type definitions
 * 
 *    Rev 1.103   09 Jun 2003 16:57:04   vangulr
 * SCR(s) 6755 :
 ...
 * 
 * 
 *    Rev 1.102   02 May 2003 10:14:20   vangulr
 * SCR(s) 6151 :
 * Add pts_offset and dma_mux memory locations
 * 
 * 
 *    Rev 1.101   13 Mar 2003 12:22:06   bintzmf
 * SCR(s) 5753 :
 * Added HSDP_BIDIR_PORT_CNTL_SER_TO_PAR_CONV_DISABLE definition to chip header file
 * 
 * 
 *    Rev 1.100   05 Mar 2003 15:51:14   bintzmf
 * SCR(s) 5634 :
 * added CHIP_SUPPORTS_PIO_TIMED_RESET feature definition to chip header files
 * 
 * 
 *    Rev 1.99   28 Feb 2003 11:15:32   aernedj
 * SCR(s) 4672 :
 * for audio AUTO_DETECT feature, added DPS_AUDIO_PID_STREAM_ID_EX at address
 * DPS_BASE + 0x1FC
 * 
 *    Rev 1.98   04 Feb 2003 17:07:46   vangulr
 * SCR(s) 5407 :
 * Change scrambling status to use separate TS and PES registers
 * 
 * 
 *    Rev 1.97   15 Jan 2003 15:51:26   jackmaw
 * SCR(s) 5095 :
 * Added specification of INTERNAL_DEMOD as NOT_PRESENT.
 * 
 *    Rev 1.96   17 Dec 2002 15:56:16   whiteth
 * SCR(s) 5182 :
 * Remove ARM_PIT_TYPE, no longer needed.  Added HAS_WB_CACHE_BUG to ensure WB cache
 * is never enabled on a Hondo since it's pre-Rev_2 ARM940.  Added default ASB_MODE value.
 * 
 * 
 *    Rev 1.95   12 Dec 2002 17:15:18   whiteth
 * SCR(s) 5157 :
 * Removed ISHONDO macro (moved to hwconfig.h along with the others).  Removed the PCI_ROM_MODE_REG_TYPE def'n.
 * 
 * 
 *    Rev 1.94   10 Dec 2002 13:59:08   vangulr
 * SCR(s) 5121 :
 * Add scrambler status memory location for demux
 * 
 * 
 *    Rev 1.93   06 Dec 2002 17:12:32   dawilson
 * SCR(s) 4903 :
 * Added new chip features to differentiate some DRM function changes in Brazos
 * 
 *    Rev 1.92   30 Oct 2002 14:46:14   bradforw
 * SCR(s) 4866 :
 * Fixed the PLL_PIN_ALT_FUNCT_AFE_DAA_DEL values ...
 * the values in the header files matched the specs, but the
 * spec is backwards.
 ...
 * bit 17 to bit 24 (for Kobuk ... Wabash is actually a don't care)
 * 
 *    Rev 1.91   21 Oct 2002 15:47:10   velusws
 * SCR(s) 4790 :
 * added define for the Audio AC3 Align Error
 * 
 *    Rev 1.90   11 Oct 2002 11:20:44   bintzmf
 * SCR(s) 4431 :
 * Added config option for hsx arbiter type
 * 
 * 
 *    Rev 1.89   18 Sep 2002 16:25:28   kroescjl
 * SCR(s) 4610 :
 * added DPS_ macro needed for crc notification feature
 * 
 *    Rev 1.88   17 Sep 2002 16:49:42   vancec
 * SCR(s) 4613 :
 * Added HAS_INTERNAL_PCI32 and HAS_EXTERNAL_PCI32
 * 
 *    Rev 1.87   30 Aug 2002 17:34:52   velusws
 * SCR(s) 4502 :
 * Defines for using the New IIC interface
 * 
 *    Rev 1.86   30 Aug 2002 14:02:52   wangl2
 * SCR(s) 4499 :
 * Define INTEXP_TYPE as NOT_PRESENT.
 * 
 *    Rev 1.85   30 Aug 2002 13:40:26   vangulr
 * SCR(s) 4485 :
 * Add defines to support CRC checking in demux driver
 * 
 * 
 *    Rev 1.84   22 Aug 2002 17:02:42   donaheb
 * SCR(s) 4464 :
 * Repaired DRMYCCPAL_CB_* and DRMYCCPAL_CR_* to correctly match YCbCr ordering
 * applicable to default 8 bit palette
 * 
 * 
 *    Rev 1.83   22 Aug 2002 15:03:24   wangl2
 * SCR(s) 4459 :
 * Define PCI_ROM_MODE_REG_TYPE.
 * 
 *    Rev 1.82   15 Aug 2002 18:22:32   rossst
 * SCR(s) 4409 :
 * Moved all default feature defnitions here from hwconfig. Also moved ISHONDO macro here from startup.h.
 * 
 *    Rev 1.81   15 Aug 2002 14:54:58   whiteth
 * SCR(s) 4398 :
 * Removed the #define's for ULTRAxxxxx.
 * 
 * 
 *    Rev 1.80   14 Aug 2002 15:55:06   dawilson
 * SCR(s) 4371 :
 * Corrected definition of DRM_COLOR_KEY_REG contents. Should be 24 bits +
 * 8 reserved bits rather than 16 + 16 reserved.
 * 
 *    Rev 1.79   14 Jun 2002 10:08:14   vancec
 * SCR(s) 3786 :
 * Allowed use of DRM bitfields only in individual c files by putting 
 * #define USE_BITFIELD_DRM
 * at the top of a c file before #include'ing any header files that
 ...
 * are pervasive, especially the RBG and YCC bitfields.
 * 
 *    Rev 1.78   13 Jun 2002 09:54:48   vancec
 * SCR(s) 3786 :
 * Turned off use of DRM bitfields.
 * 
 *    Rev 1.77   06 Jun 2002 16:54:32   dryd
 * SCR(s) 3923 :
 * Remove MPG bitfields conditionally - Step 1
 * 
 *    Rev 1.76   03 Jun 2002 13:49:16   dryd
 * SCR(s) 3922 :
 * Conditionally remove SYN bitfield structures from header files
 * 
 *    Rev 1.75   03 Jun 2002 11:52:14   vancec
 * SCR(s) 3918 :
 * Forgot to change one use of PLL_LOCK_CMD to PLL_LOCK_CMD_VALUE. Fixed it.
 * 
 *    Rev 1.74   03 Jun 2002 11:43:46   vancec
 * SCR(s) 3918 :
 ...
 * 
 *    Rev 1.73   31 May 2002 18:29:02   dryd
 * SCR(s) 3916 :
 * Eradicate bitfield use from AFE code
 * 
 *    Rev 1.72   31 May 2002 11:09:22   dryd
 * SCR(s) 3908 :
 * Eradicate bitfield use from Smart Card(SMC) code, step 1
 * 
 *    Rev 1.71   30 May 2002 11:32:56   whiteth
 * SCR(s) 3899 :
 * Add WARM_RESET support.
 * 
 * 
 *    Rev 1.70   22 May 2002 16:42:18   dryd
 * SCR(s) 3855 :
 * Eradicate bitfield use from SER(Serial) code, step 1
 * 
 *    Rev 1.69   21 May 2002 13:05:54   whiteth
 * SCR(s) 3642 :
 * Add DPS_PCR_BLOCK_STORED bit definition for new pawser microcode build option -dPCR_PID_INT.
 * 
 * 
 *    Rev 1.68   21 May 2002 12:32:38   vancec
 * SCR(s) 3786 :
 * Added LPREG in front of DRM register addresses.
 * 
 *    Rev 1.67   20 May 2002 11:55:22   glennon
 * SCR(s): 3830 
 * Changed the CONTROL1 bitfield Reserved2 field to HaltDecode to match 
 * colorado.h
 * 
 * 
 *    Rev 1.66   17 May 2002 11:17:42   dryd
 * SCR(s) 3810 :
 * Eradicate bitfield use from IRD code
 * 
 *    Rev 1.65   15 May 2002 14:09:10   dryd
 * SCR(s) 3794 :
 * Eradicate bitfields from PAR module
 * 
 *    Rev 1.64   15 May 2002 13:56:16   vancec
 * SCR(s) 3786 :
 * Added constants for DRM bitfields.
 * 
 *    Rev 1.63   15 May 2002 11:19:34   vancec
 * SCR(s) 3789 1238924 :
 * Clean up audio bitfield masks.
 * 
 *    Rev 1.62   14 May 2002 16:24:04   dryd
 * SCR(s) 3784 :
 * Eradicate bitfields from PWM(Pulse Width Modulator)
 * 
 *    Rev 1.61   14 May 2002 10:45:34   dryd
 * SCR(s) 3776 :
 * Eradicate bitfield use from PLS(Pulse Timer), step 1
 * 
 *    Rev 1.60   13 May 2002 12:55:44   whiteth
 * SCR(s) 3760 :
 * Updated DPS_ definition section.
 * 
 * 
 *    Rev 1.59   10 May 2002 14:19:50   dryd
 * SCR(s) 3754 :
 * Eradicate bitfield use from SDR(SDRAM) code
 *
 *    Rev 1.58   07 May 2002 16:58:14   dryd
 * SCR(s) 3726 :
 * Eradicate bitfield use from I2C, step 1
 * 
 *    Rev 1.57   07 May 2002 16:10:10   whiteth
 * SCR(s) 3721 :
 * Remove ENC_ bitfield usage from codebase.
 * 
 * 
 *    Rev 1.56   06 May 2002 16:59:36   whiteth
 * SCR(s) 3714 :
 * Update HSDP_ macro definitions to use new bitfield-less format.
 * 
 * 
 *    Rev 1.55   03 May 2002 14:49:22   dryd
 * SCR(s) 3671 :
 * Eradicate bitfield use from TIM module
 * 
 *    Rev 1.54   03 May 2002 13:47:02   whiteth
 * SCR(s) 3696 :
 * Remove RST_ bitfields from codebase.
 * 
 * 
 *    Rev 1.53   03 May 2002 12:56:48   dawilson
 * SCR(s) 3688 :
 * Added definitions of new parser events used to detect data on audio and
 * video PIDs.
 *
 *    Rev 1.52   02 May 2002 16:25:42   whiteth
 * SCR(s) 3693 :
 * Use "UL" in the macro bit definitions to force unsigned and fix compiler warnings.
 * 
 * 
 *    Rev 1.51   01 May 2002 18:00:20   vancec
 * SCR(s) 3659 :
 * Removed audio bitfield types.
 * 
 *    Rev 1.50   01 May 2002 16:45:08   whiteth
 * SCR(s) 3678 :
 * Remove GCP_ & ARM_ bitfields usage from the codebase.
 * 
 * 
 *    Rev 1.49   01 May 2002 14:30:50   whiteth
 * SCR(s) 3673 :
 * Remove PLL_ bitfields usage from codebase.
 * 
 * 
 *    Rev 1.48   30 Apr 2002 16:38:08   kroescjl
 * SCR(s) 3243 :
 * added definition for new parser event bit (bad PES header)
 * 
 *    Rev 1.47   30 Apr 2002 15:20:20   dryd
 * SCR(s) 3662 :
 * Use same build configurations as were used to test defect 3509. 
 * 
 *    Rev 1.46   30 Apr 2002 13:56:08   vancec
 * SCR(s) 3659 :
 * Removing bitfields from audio, step 1.
 * 
 * 
 *    Rev 1.45   30 Apr 2002 11:58:54   jackmaw
 * SCR(s) 3656 :
 * Changed expression (1<<31) to ((unsigned)1<<31) to avoid compiler warning
 * in SDT toolset.
 * 
 *    Rev 1.44   29 Apr 2002 17:17:10   dryd
 * SCR(s) 3652 :
 * Eliminate bitfield use from Movie (MOV) module by conditional compilation.
 * 
 *    Rev 1.43   24 Apr 2002 15:28:02   dawilson
 * SCR(s) 3611 :
 * 
 * 
 * Updated MPG_VID_SIZE_REG bit definitions in line with latest microcode.
 * 
 *    Rev 1.42   22 Apr 2002 14:22:20   wangl2
 * SCR(s) 3585 :
 ...
 * 
 *    Rev 1.41   19 Apr 2002 16:52:54   dryd
 * SCR(s) 3588 :
 * Conditionally compile out RTC bitfield definitions.
 * 
 *    Rev 1.40   18 Apr 2002 10:10:24   dryd
 * SCR(s) 3576 :
 * GXA bitfield definitions are now conditionally compiled out.
 * 
 *    Rev 1.39   12 Apr 2002 18:50:32   whiteth
 * SCR(s) 3558 :
 * Remove hardware register access macros.  Now in hwconfig.h.
 * 
 * 
 *    Rev 1.38   11 Apr 2002 14:15:22   whiteth
 * SCR(s) 3543 :
 * Changed BITFIELD #define to be in the <chipname>.h header files since
 ...
 * 
 * 
 *    Rev 1.37   10 Apr 2002 16:15:46   whiteth
 * SCR(s) 3509 :
 * Eradicate external bus (PCI) bitfield usage.
 * 
 *
 *    Rev 1.18   09 Oct 2001 14:56:28   bradforw
 * SCR(s) 2729 :
 * Modified a few C macro definitions for the DMA macros.
 * Added a few extra ones, as well.  The HONDO DMA registers
 * are slightly different than COLORADO, and these differences
 * had not been incorporated into the HONDO.H file yet.
 *
 *    Rev 1.17   06 Sep 2001 11:13:10   whiteth
 * SCR(s) 2592 :
 * Added Per-Slot-PSI/PES buffer support for the new microcodes
 * built with -dMULTI_PSI.  In the source tree, these microcodes
 * are denoted with a "p" (e.g. dvb_anp.c is the Colorado version
 * of BSkyB NDS Per-Slot-PSI micrcode).
 *
 *    Rev 1.16   02 Aug 2001 14:40:56   angela
 * SCR(s) 2430 :
 * added define MPEG_CORE_RESET_HIGH
 *
 *    Rev 1.15   13 Jul 2001 14:06:06   whiteth
 * SCR(s) 2281 :
 * Changed DPS_BASE macro from being a macro concatenation to adding an offset.
 *
 *    Rev 1.14   12 Jul 2001 16:02:40   vangulr
 * SCR(s) 2267 :
 * Add struct's and #defines for Hondo specific ATA code
 *
 *    Rev 1.13   12 Jul 2001 11:53:58   whiteth
 * SCR(s) 2261 2259 2260 :
 * Added multi-instance HW DMX register interface.
 * 
 *    Rev 1.12   29 Jun 2001 13:20:22   prattac
 * SCR(s) 1642 :
 * Merging in previous unintentional branches.
 * For SCR 2162:  Added HAS_PCI32 == YES definition.
 * For SCR 1642:  Removed defines for AUDIO_MICROCODE, VIDEO_MICROCODE, 
 * and PAWSER_MICROCODE.  They are used by .mak files, so I moved them to
 * cx2249t.cfg and cx2249x.cfg.
 * 
 *    Rev 1.11.1.0.1.0   28 Jun 2001 15:27:22   prattac
 * SCR(s) 1642 :
 * Removed defines for AUDIO_MICROCODE, VIDEO_MICROCODE, and PAWSER_MICROCODE.
 * They are used by .mak files, so I moved them to cx2249t.cfg and cx2249x.cfg.
 * 
 *    Rev 1.11.1.0   27 Jun 2001 17:44:42   mooreda
 * SCR(s) 2162 :
 * Added HAS_PCI32 == YES definition.
 * 
 *    Rev 1.11   13 Jun 2001 15:32:30   bintzmf
 * SCR(s) 2084 :
 * The CNXT_REG_SET macro was defined incorrectly.  This macro is used in ttx_vbi.c for touching
 * the TV encoder registers.
 * 
 *    Rev 1.10   11 May 2001 10:43:24   whiteth
 * DCS#1894/1895/1896 -- Changed MPG_COMMAND_PAUSE from 0x28 to 0x1028.
 * 
 *    Rev 1.9   27 Apr 2001 18:26:14   bintzmf
 * added hondo built-in encoder structures/macros
 * 
 *    Rev 1.8   26 Apr 2001 17:45:26   prattac
 * updated HSDP registers (see DPS section.)
 * 
 *    Rev 1.7   24 Apr 2001 15:41:38   prattac
 * Re-sync with colorado.h
 * 
 *    Rev 1.6   22 Apr 2001 16:17:26   prattac
 * Added SDRAM Rank 0 Empty bit.
 * 
 *    Rev 1.5   18 Apr 2001 16:33:24   prattac
 * DCS1642 Added chip feature definitions in preparation for new Hondo code.
 * 
 *    Rev 1.4   17 Apr 2001 16:26:00   prattac
 * Updated MPG section to 4/16 spec.
 * 
 *    Rev 1.3   17 Apr 2001 14:55:02   prattac
 * Updated MPG section to match 3/5 Hondo spec.
 * 
 *    Rev 1.2   16 Apr 2001 16:31:10   prattac
 * Updated pin muxing and PLL definitions to match Hondo spec.
 * 
 *    Rev 1.1   19 Mar 2001 16:11:48   rossst
 * DCS966. Started adding some feature definitions.
 * 
 *    Rev 1.0   19 Mar 2001 16:11:24   rossst
 * Initial revision.
 * 
 *    Rev 1.0   01 Feb 2001 13:11:14   rossst
 * Initial revision.
 * 
 ****************************************************************************/
